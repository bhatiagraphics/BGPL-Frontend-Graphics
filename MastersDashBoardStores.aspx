<%@ Page Title="ERP" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="MastersDashBoardStores.aspx.vb" Inherits="MastersDashBoardStores" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Purchase &amp; Stores - Master</h4>
                </div>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label ID="Label708" runat="server" CssClass="EntryFormHeadingNew"
                                        Font-Bold="False" Font-Size="13pt" Text="Supplier" Width="300px"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew"
                                        ...
                                        ForeColor="#609ED2">&gt; Supplier Master</asp:HyperLink></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>
