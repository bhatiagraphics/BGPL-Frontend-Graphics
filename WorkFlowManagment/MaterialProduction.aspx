<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="MaterialProduction.aspx.vb" Inherits="MaterialProductionNew" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Material Production</h4>
                </div>
                                    ...
                                    <div class="col-md-3 nopadding_left">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtjobname" Enabled="false" runat="server" autocomplete="off" CssClass="form-control input-sm " MaxLength="60"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel37" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlcuscode" Enabled="false" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel33" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtintcode" Enabled="false" runat="server" CssClass="form-control input-sm" MaxLength="60"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3 nopadding_left">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel34" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtrevno" Enabled="false" runat="server" CssClass="form-control input-sm" MaxLength="60"></asp:TextBox>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto_materialprod" Enabled="false" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>

                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlassignedto_materialprod" ErrorMessage="Job Assign To"></asp:RequiredFieldValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 nopadding_left  m-b-15">
                                            <label class="">Is The Job Taken For Ablation ?</label>
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlisjob_taken_abalation" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem>Yes</asp:ListItem>
                                                            <asp:ListItem>No</asp:ListItem>

                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlisjob_taken_abalation" ErrorMessage="Is The Job Taken For Ablation"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="col-md-12 nopadding_left">
                                            <div class="">
                                                <label class="">Comments Send To Reproduction </label>
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtsendfor_reproduction_remark" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req" ReadOnly="true"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtjobtaken_abalation_comments" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnSendForChallan" runat="server" CssClass="btn btn-info m-r-10"
                                                                Text="Send To Challan" />

                                                        </td>

                                                        <td>
                                                            <asp:Button ID="btnSendForQC" runat="server" CssClass="btn btn-info m-r-10"
                                                                Text="Send To QC" />
