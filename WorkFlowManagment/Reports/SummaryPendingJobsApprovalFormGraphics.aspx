<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="SummaryPendingJobsApprovalFormGraphics.aspx.vb" Inherits="SummaryPendingJobsApprovalFormGraphics" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > PENDING JOBS APPROVAL FORM GRAPHICS (SUMMARY) </span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Pending_Jobs_Approval_form_Graphics_Summary" runat="server" AutoGenerateColumns="False" 
 ...
 <%--                                       <GroupSummary>
                                             <dx:ASPxSummaryItem FieldName="cnt" ShowInGroupFooterColumn="cnt" SummaryType="Sum" ValueDisplayFormat="0.00"  DisplayFormat="{0:N2}"/>
                                         </GroupSummary>--%>                                        
                                        <Styles>
