<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="CompletedJobsforBilling.aspx.vb" Inherits="CompletedJobsforBilling" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > COMPLETED JOBS FOR BILLING</span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Completed Jobs for Billing</asp:HyperLink>--%>
                                    ...
                                    Width="70px"></asp:Label>
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:Label ID="Label2" runat="server" CssClass="LableInterface" 
                                                        Font-Bold="False" ForeColor="White" Text="Printing Type" Width="80px" Height="21px"></asp:Label>           
                                                    </td>
                                                    <td class="style253">
                <asp:DropDownList ID="ddlprinttype" runat="server" Width="200px" 
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Completed_Jobs_for_Billing" runat="server" AutoGenerateColumns="False" 
                                      ...
                                      <Settings ShowGroupPanel="True" ShowFooter="True" ShowFilterRow="True" VerticalScrollBarMode="Visible" VerticalScrollableHeight="500"/>  
                                        ...
                                        <Columns>
                                        <dx:GridViewDataTextColumn Caption="Job ID" FieldName="jobid" VisibleIndex="1" HeaderStyle-HorizontalAlign="Left" Width="100px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>                                  
                                        </dx:GridViewDataTextColumn> 
                                         <dx:GridViewDataTextColumn Caption="Job Name" FieldName="jobname" VisibleIndex="2" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn> 
                                         <dx:GridViewDataTextColumn Caption="Customer" FieldName="cusname" VisibleIndex="3" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn> 
                                         <dx:GridViewDataTextColumn Caption="Int. Code" FieldName="intcode" VisibleIndex="4" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn> 
                                         <dx:GridViewDataTextColumn Caption="Rev" FieldName="revno" VisibleIndex="5" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn> 
                                         <dx:GridViewDataTextColumn Caption="Priority" FieldName="prioirty" VisibleIndex="6" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>
                                         <dx:GridViewDataTextColumn Caption="Printing Type" FieldName="printname" VisibleIndex="7" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                                   
                                        <dx:GridViewDataTextColumn Caption="Date & Time" FieldName="jobcreatedt" VisibleIndex="9" HeaderStyle-HorizontalAlign="Right" Width="150px">
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                                   
                                        <dx:GridViewDataTextColumn Caption="Plate Processed Date" FieldName="plateprocessdate" VisibleIndex="10" HeaderStyle-HorizontalAlign="Right" Width="150px">
                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Plate Type" FieldName="platetypename" VisibleIndex="11" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Length of Plate" FieldName="platelength" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Nof Of Plate" FieldName="noofplates" VisibleIndex="13" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Width of Plate" FieldName="platewidth" VisibleIndex="14" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Chllan No" FieldName="chlno" VisibleIndex="15" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                                   
                                        <dx:GridViewDataTextColumn Caption="Challan Date" FieldName="chldt" VisibleIndex="16" HeaderStyle-HorizontalAlign="Right" Width="150px">
                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>											
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Ticket No" FieldName="ticketno" VisibleIndex="17" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  										
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Assigned To" FieldName="assignedname" VisibleIndex="18" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Operator" FieldName="opname" VisibleIndex="19" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Courier" FieldName="transname" VisibleIndex="20" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  											
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Docket No" FieldName="docketno" VisibleIndex="21" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Bill No" FieldName="billno" VisibleIndex="22" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  						
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Bill Date" FieldName="billdt" VisibleIndex="23" HeaderStyle-HorizontalAlign="Left" Width="200px">
										 <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  											  																						
                                        </dx:GridViewDataTextColumn>                                             
                                        </Columns>        
