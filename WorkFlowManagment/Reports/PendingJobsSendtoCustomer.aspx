<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PendingJobsSendtoCustomer.aspx.vb" Inherits="PendingJobsSendtoCustomer" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > PENDING JOBS SEND TO CUSTOMER</span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Pending Jobs Send to Customer</asp:HyperLink>--%>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Pending_Jobs_Send_to_Customer" runat="server" AutoGenerateColumns="False" 
...
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Status" FieldName="status" VisibleIndex="10" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                         ...
                                         <dx:GridViewDataTextColumn Caption="Ticke No" FieldName="ticketno" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  											
                                        </dx:GridViewDataTextColumn>                                             
                                        </Columns>        
                                        <Styles>
