<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PendingJobsApprovalformGraphics.aspx.vb" Inherits="PendingJobsApprovalformGraphics" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > PENDING JOBS APPROVAL FORM GRAPHICS </span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Pending Jobs Approval form Graphics</asp:HyperLink>--%>
                                    ...
                                    Width="70px"></asp:Label>
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:Label ID="Label1" runat="server" CssClass="LableInterface" 
                                                        Font-Bold="False" ForeColor="White" Text="Assigned To" Width="80px" Height="21px" Visible="false" ></asp:Label>                                                           
                                                    </td>
                                                    <td class="style139">
                                                        &nbsp;</td>
                                                    <td class="style139">
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Pending_Jobs_Approval_form_Graphics" runat="server" AutoGenerateColumns="False" 
...
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Status" FieldName="status" VisibleIndex="10" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>    
                                         ...
                                         <dx:GridViewDataTextColumn Caption="Ticket No" FieldName="ticketno" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  											
                                        </dx:GridViewDataTextColumn>                                             
                                        </Columns>        
                                        <Styles>
