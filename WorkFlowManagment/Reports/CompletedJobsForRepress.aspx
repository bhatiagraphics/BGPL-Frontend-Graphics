<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="CompletedJobsForRepress.aspx.vb" Inherits="CompletedJobsForRepress" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > COMPLETED JOBS FOR PREPRESS</span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Completed Jobs for Prepress</asp:HyperLink>--%>
                                    ...
                                    Width="70px"></asp:Label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="style139">
                                                        &nbsp;</td>
                                                    <td class="style276">
                <asp:DropDownList ID="ddlassignedto" runat="server" Width="200px" 
                    CssClass="form-control searchableddl" Height="28px" Visible ="false" >
                </asp:DropDownList>                                                         
                                                    </td>
                                                    <td class="style139">
                                                        &nbsp;</td>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Completed_Jobs_For_Repress" runat="server" AutoGenerateColumns="False" 
                                      ...
                                      <Settings ShowGroupPanel="True" ShowFooter="True" ShowFilterRow="True" VerticalScrollBarMode="Visible" VerticalScrollableHeight="500"/>  
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Date & Time" FieldName="jobcreatedt" VisibleIndex="8" HeaderStyle-HorizontalAlign="Right" Width="150px">
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                                   
                                        <dx:GridViewDataTextColumn Caption="Plate Processed Date" FieldName="plateprocessdate" VisibleIndex="9" HeaderStyle-HorizontalAlign="Right" Width="150px">
                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>											
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Assigned To" FieldName="assignedname" VisibleIndex="10" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         ...
                                         <dx:GridViewDataTextColumn Caption="Printer" FieldName="printername" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="No of Plates" FieldName="noofplates" VisibleIndex="13" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle> 
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Read UnRead" FieldName="readable" VisibleIndex="14" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  											
                                        </dx:GridViewDataTextColumn>                                     
                                         <dx:GridViewDataTextColumn Caption="Ticket No" FieldName="ticketno" VisibleIndex="15" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  																						
                                        </dx:GridViewDataTextColumn>                                             
                                        </Columns>        
                                        <Styles>
