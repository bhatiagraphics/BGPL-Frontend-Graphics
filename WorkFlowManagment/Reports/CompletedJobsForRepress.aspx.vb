...
Partial Class CompletedJobsForRepress
    ...
    Private Sub CreateGridView()
        Completed_Jobs_For_Repress.SettingsBehavior.AllowFocusedRow = True
        Completed_Jobs_For_Repress.DataSource = CreateData()
    ...
    Protected Sub ASPxGridView1_CustomCallback(ByVal sender As Object, ByVal e As ASPxGridViewCustomCallbackEventArgs) Handles Completed_Jobs_For_Repress.CustomCallback
        Completed_Jobs_For_Repress.Columns.Clear()
        Completed_Jobs_For_Repress.AutoGenerateColumns = False
        Completed_Jobs_For_Repress.DataBind()
    End Sub
    ...
    Private Sub GridChkbox()
        ...
        For Each column As GridViewDataColumn In Completed_Jobs_For_Repress.Columns
