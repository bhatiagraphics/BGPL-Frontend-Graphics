<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PendingJobsforQCCheck.aspx.vb" Inherits="PendingJobsforQCCheck" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > PENDING JOBS FOR QC CHECK </span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Pending Jobs for QC Check</asp:HyperLink>--%>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Pending_Jobs_for_QC_Check" runat="server" AutoGenerateColumns="False" 
...
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Status" FieldName="status" VisibleIndex="11" HeaderStyle-HorizontalAlign="Left" Width="150px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Assigned To" FieldName="assignedname" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Plate Type" FieldName="platetypename" VisibleIndex="13" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Printer" FieldName="printername" VisibleIndex="14" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="No of Plates" FieldName="noofplates" VisibleIndex="15" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Read UnRead" FieldName="readable" VisibleIndex="16" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Operator" FieldName="opname" VisibleIndex="17" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>    
                                         <dx:GridViewDataTextColumn Caption="Ticket No" FieldName="ticketno" VisibleIndex="18" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
