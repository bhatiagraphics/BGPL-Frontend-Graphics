<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="CompletedJobsforMaterialProduction.aspx.vb" Inherits="CompletedJobsforMaterialProduction" title="ERP" %>
            ...
            <tr>
               <td align="left" 
                     style="border-bottom-width: 1px; border-bottom-color: #1279C0; border-bottom-style: solid; padding-bottom: 4px;">
                                    <span id="ctl00_ContentPlaceHolder1_Label685" class="EntryFormHeadingNew" style="font-weight:normal;"   > COMPLETED JOBS FOR MATERIAL PRODUCTION </span>
...
<%--                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" 
                                        ...
                                        ForeColor="#609ED2">&gt; Report &gt; Completed Jobs for Material Production</asp:HyperLink>--%>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td align="left" class="dx-justification" style="vertical-align: top">
                                    <dx:ASPxGridView ID="Completed_Jobs_for_Material_Production" runat="server" AutoGenerateColumns="False" 
...
<%--                                               <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy" />  --%>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Plate Processed Date" FieldName="plateprocessdate" VisibleIndex="10" HeaderStyle-HorizontalAlign="Right" Width="150px">
                                         ...
                                         <dx:GridViewDataTextColumn Caption="Assigned To" FieldName="assignedname" VisibleIndex="11" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        </dx:GridViewDataTextColumn>                                       
                                         <dx:GridViewDataTextColumn Caption="Plate Type" FieldName="platetypename" VisibleIndex="12" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                       
                                         <dx:GridViewDataTextColumn Caption="Printer" FieldName="printername" VisibleIndex="13" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                       
                                         <dx:GridViewDataTextColumn Caption="No of Plates" FieldName="noofplates" VisibleIndex="14" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                       
                                         <dx:GridViewDataTextColumn Caption="Read UnRead" FieldName="readable" VisibleIndex="15" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  
                                        </dx:GridViewDataTextColumn>                                       
                                         <dx:GridViewDataTextColumn Caption="Operator" FieldName="opname" VisibleIndex="16" HeaderStyle-HorizontalAlign="Left" Width="200px">
                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>  							
                                        </dx:GridViewDataTextColumn>                                       
