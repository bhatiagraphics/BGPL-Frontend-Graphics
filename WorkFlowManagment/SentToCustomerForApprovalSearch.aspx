<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="SentToCustomerForApprovalSearch.aspx.vb" Inherits="SentToCustomerForApprovalSearch" %>
                                ...
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                                 ...
                                                 <dx:GridViewDataTextColumn Caption="Job Send To Customer" FieldName="jobsentcustomer_forapproval"
                                            VisibleIndex="9">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
