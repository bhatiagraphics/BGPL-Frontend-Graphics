<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="RateList.aspx.vb" Inherits="RateList" Title="ERP" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Rate List Master  </h4>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel87" runat="server">
                        <ContentTemplate>
                           ...
                           <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False" 
                                            EnableViewState="False" KeyFieldName="srno" 
                            ...
                            <DataItemTemplate>
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Sr No." FieldName="srno" 
                                                    VisibleIndex="1" Width="200px" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>

                                                  <dx:GridViewDataTextColumn Caption="Date" FieldName="rdate1" 
                                                    VisibleIndex="2">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Plate Type" FieldName="platetypename" 
                                                    VisibleIndex="4">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>

                                                 <dx:GridViewDataTextColumn Caption="Rate" FieldName="rate" 
                                                    VisibleIndex="5">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
    ...
    <table>
                                        ...
                                        <tr>
                                            <td colspan="6" class="Headingseparator">
                                                ...
                                                <asp:Label ID="Label240" runat="server" CssClass="EntryFormHeadingNew" 
                                                    Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="Rate List"></asp:Label>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                           ...
                                           <tr>
                                            ...
                                            <td class="style107">
                                                             ...
                                                             <asp:TextBox ID="txtrdate" runat="server" CssClass="form-control input-sm" Width="180px"></asp:TextBox>
                            <asp:MaskedEditExtender ID="txtdate_Date" runat="server" Mask="99/99/9999" MaskType="Date" PromptCharacter="_" TargetControlID="txtrdate" />
                            <asp:CalendarExtender ID="txtdate_CalendarExtender" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="txtrdate" TargetControlID="txtrdate">
                                         ...
                                         <tr>
                                            ...
                                            <td class="style83">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtrdate" ErrorMessage="Enter Date"></asp:RequiredFieldValidator>
                                            </td>
                                            <td class="style78">
                                                &nbsp;</td>
                                            <td class="style79">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label2" runat="server" CssClass="LableInterface" 
                                                    Text="Customer" Width="140px"></asp:Label>
                                            </td>
                                            <td class="style83">
                                                &nbsp;</td>
                                            <td class="style107">
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList Theme="Metropolis" ValueType="System.String" ID="ddlcuscode" runat="server" AutoPostBack ="true" 
                                                                CssClass="form-control searchableddl req" Width="323px">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style83">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ddlcuscode" ErrorMessage="Enter Customer"></asp:RequiredFieldValidator>
                                            </td>
                                            <td class="style78">
                                                &nbsp;</td>
                                            <td class="style79">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label233" runat="server" CssClass="LableInterface" 
                                                    Text="Plate Type" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                                            <asp:DropDownList Theme="Metropolis" ValueType="System.String" ID="ddlplatetypecd" runat="server" AutoPostBack ="true" 
                                                                CssClass="form-control searchableddl req" Width="323px">
                                                            </asp:DropDownList>
                                            </td>
                                            <td class="style79">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlplatetypecd" ErrorMessage="Select Plate Type"></asp:RequiredFieldValidator>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label1" runat="server" CssClass="LableInterface" 
                                                    Text="Rate List" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                             <asp:TextBox ID="txtrate" runat="server" autocomplete="off" CssClass="form-control input-sm req " AutoPostBack="true" style="margin-left: 0px; text-align: right" Width="120px"></asp:TextBox>
                                             <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtrate" ValidChars="." />
                                            </td>
                                            <td class="style79">
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtrate" ErrorMessage="Enter Rate"></asp:RequiredFieldValidator>
                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" colspan="4" style="padding-top:12px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" class="style77" width="100px">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-info" Font-Bold="False" Text="Save" />
                                                                        </td>
                                                                        <td>&nbsp; </td>
                                                                        <td>
                                                    ...
                                                    <td align="center" style="padding-top:12px"></td>
                                                    <td class="style79">&nbsp;</td>
                                                </td>
                                            </tr>
                                        </caption>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                            ...
                            <asp:HiddenField ID="HFcuscodeold" runat="server" />
                            <asp:HiddenField ID="HFplatetypecdold" runat="server" />
