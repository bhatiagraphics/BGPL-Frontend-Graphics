<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="CityMaster.aspx.vb" Inherits="CityMaster"  %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel87" runat="server">
                        <ContentTemplate>
                              ...
                              <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False" 
                                            EnableViewState="False" KeyFieldName="citycd" 
                            ...
                            <DataItemTemplate>
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click1"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="City Code" FieldName="citycd" 
                                                    VisibleIndex="1" Width="200px" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="City Name" FieldName="cityname" 
                                                    VisibleIndex="2">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                ...
                                <div>
                                    <table class="auto-style1">
                                        <tr>
                                            <td colspan="6" class="Headingseparator">
                                                ...
                                                <asp:Label ID="Label240" runat="server" CssClass="EntryFormHeadingNew" 
                                                    Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="City Master"></asp:Label>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label233" runat="server" CssClass="LableInterface" 
                                                    Text="City Name" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                                <asp:TextBox ID="txtcityname" runat="server" autocomplete="off" 
                                        ...
                                        <tr> 
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtcityname" ErrorMessage="Enter City Name"></asp:RequiredFieldValidator>
                                         ...
                                         <tr>
                                            ...
                                            <td align="right" class="style83">
                                             <asp:Label ID="Label1" runat="server" CssClass="LableInterface" 
                                                    Text="State" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">&nbsp;</td>
                                            ...
                                            <td align="left" class="style83">
                                                ...
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlstatecd"  Width="373px" runat="server" AutoPostBack ="true"  CssClass="form-control searchableddl req">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                               </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="auto-style4">
                                             <asp:Label ID="Label2" runat="server" CssClass="LableInterface" 
                                                    Text="Country" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="auto-style4"></td>
                                            <td align="left" class="auto-style4">
                                                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                             <%--       <asp:DropDownList ID="ddlcountrycd"  Width="373px" runat="server" ValueType="System.String" CssClass="form-control searchableddl req">
                                                    </asp:DropDownList>--%>
                                                <asp:TextBox ID="txtCountrycd" runat="server" autocomplete="off" AutoPostBack="true" 
                                                    CssClass="form-control input-sm req" MaxLength="60" 
                                                    Style="margin-top: 0px; " Width="373px" ReadOnly="true"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left" class="auto-style4">
                                                ...
                                                &nbsp;</td>
                                              <td align="left" class="auto-style4">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCountrycd" ErrorMessage="Enter Country"></asp:RequiredFieldValidator>
