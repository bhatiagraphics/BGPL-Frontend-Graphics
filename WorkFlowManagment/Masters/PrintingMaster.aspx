<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PrintingMaster.aspx.vb" Inherits="PrintingMaster"  %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Printing Master</h4>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel87" runat="server">
                        <ContentTemplate>
                           ...
                           <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False" 
                                            EnableViewState="False" KeyFieldName="printcd" 
                            ...
                            <DataItemTemplate>
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Printing Code" FieldName="printcd" 
                                                    VisibleIndex="1" Width="200px" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Printing Name " FieldName="printname" 
                                                    VisibleIndex="2">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
...
<div>
    <table>
                                ...
                                <div>
                                    <table class="auto-style1">
                                        <tr>
                                            <td colspan="6" class="Headingseparator">
                                                ...
                                                <asp:Label ID="Label240" runat="server" CssClass="EntryFormHeadingNew" 
                                                    Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="Printing Master"></asp:Label>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label233" runat="server" CssClass="LableInterface" 
                                                    Text="Printing Name" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                                <asp:TextBox ID="txtPrintingName" runat="server" autocomplete="off" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtPrintingName" ErrorMessage="Enter Printing Name"></asp:RequiredFieldValidator>
                                            </td>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:HiddenField ID="HFPrintingCode" runat="server" />
