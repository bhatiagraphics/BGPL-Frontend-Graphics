<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="SubIndustryMaster.aspx.vb" Inherits="SubIndustryMaster" Title="ERP" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Sub Industry Master</h4>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel87" runat="server">
                        <ContentTemplate>
                              ...
                              <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False" 
                                            EnableViewState="False" KeyFieldName="subindcd" 
                            ...
                            <DataItemTemplate>
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click1"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                                ...
                                                <dx:GridViewDataTextColumn Caption="SubIndustry Code" FieldName="subindcd" 
                                                    VisibleIndex="1" Width="200px" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Sub Industry Name" FieldName="subindname" 
                                                    VisibleIndex="2" Width="350px">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Industry" FieldName="indname" 
                                                    VisibleIndex="3">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
...
<div>
    <table>
                                ...
                                <div>
                                    <table class="auto-style1">
                                        <tr>
                                            <td colspan="6" class="Headingseparator">
                                                ...
                                                <asp:Label ID="Label240" runat="server" CssClass="EntryFormHeadingNew" 
                                                    Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="Sub Industry Master"></asp:Label>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label233" runat="server" CssClass="LableInterface" 
                                                    Text="Sub Industry Name" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                                <asp:TextBox ID="txtsubindname" runat="server" autocomplete="off" 
                                        ...
                                        <tr> 
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtsubindname" ErrorMessage="Enter SubIndustry Name"></asp:RequiredFieldValidator>
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td align="right" class="style83">
                                             <asp:Label ID="Label1" runat="server" CssClass="LableInterface" 
                                                    Text="Industry" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">&nbsp;</td>
                                            ...
                                            <td align="left" class="style83">
                                                ...
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlindcd"  Width="373px" runat="server" ValueType="System.String" CssClass="form-control searchableddl req">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                               </td>
                                          ...
                                          <tr>
                                            ...
                                            <td align="left" class="auto-style4">
                                              ...
                                              <td align="left" class="auto-style4">
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlindcd" ErrorMessage="Select Industry"></asp:RequiredFieldValidator>
                                            </td>
                                              </tr>
                                        <tr>
                                             <td class="auto-style4"></td>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                  <asp:HiddenField ID="HFsubindcd" runat="server" />
                 <asp:HiddenField ID="HFindcd" runat="server" />
            </ContentTemplate>
        </asp:UpdatePanel>
                </td>
            </tr>
