...
Partial Class CountryMaster
    ...
    Private Sub DisplayData(ByVal countrycd As String)
        Try
            Dim obj As ClsCountryMaster = ClsCountryMaster.FillData(countrycd, "B")
            If Not IsNothing(obj) Then
                HFCountryCode.Value = obj.countrycd
                txtCountryName.Text = Trim(obj.countryname)
...
#End Region
    ...
    Private Function CreateData() As SqlDataSource
        Dim selectCmnd As String = "Exec Sp_country_GetData '','A' "
    ...
    Protected Sub btnEditEntry_Click(sender As Object, e As System.EventArgs)
        ...
        Dim roomName As String = DataBinder.Eval(container.DataItem, "countrycd").ToString()
    ...
    Public Function Check_Duplicate() As Boolean
        Try
            ...
            strcode = ClsCountryMaster.CheckDuplicate(txtCountryName.Text).ToString
            If Trim(strcode) <> Trim(HFCountryCode.Value) And strcode <> "" Then
                Return True
            Else
                Return False
                Exit Function
    ...
    Protected Sub btnSave_Click(sender As Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim obj As New ClsCountryMaster, objDas As New DBAccess
            obj.countrycd = HFCountryCode.Value
            obj.countryname = objDas.FilteredString(txtCountryName.Text)

            If HFCountryCode.Value = "" Then
                obj.countrycd = ClsCountryMaster.GetDocCode
                If Check_Duplicate() = True Then
                    ErrorMsg0.Text = "'" & txtCountryName.Text & "' Already Exist"
                    ErrorMsg0.Visible = True
                    Exit Try
                Else
                    ClsCountryMaster.Update_Data(obj, "ADD")
                End If
            Else
                If Check_Duplicate() = True Then
                    ErrorMsg0.Text = "'" & txtCountryName.Text & "' Already Exist"
                    ...
                    Exit Try
                Else
                    ClsCountryMaster.Update_Data(obj, "EDIT")
                End If
            End If
            'FillData()
            CreateGridView()
    ...
    Protected Sub btnDelete_Click(sender As Object, e As System.EventArgs) Handles btnDelete.Click
        Try
            If HFCountryCode.Value <> "" Then
                Dim str As String
                str = ClsCountryMaster.Check_Integrity(HFCountryCode.Value).ToString.Trim
                If str <> "" Then
                    ...
                    ErrorMsg0.Visible = True
                    ErrorMsg0.Text = ""
                    ErrorMsg0.Text = "Country Being Used In " & Trim(str)
                    str = ""
                    Exit Sub
                End If
