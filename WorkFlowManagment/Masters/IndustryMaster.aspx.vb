    ...
    Private Sub DisplayData(ByVal channelcode As String)
        Try
            ...
            If Not IsNothing(obj) Then
                'HFDesignationCode.Value = obj.channelcode
                'txtDesignationName.Text = Trim(obj.channelname)
...
#End Region
    ...
    Public Function Check_Duplicate() As Boolean
        ...
        '    strcode = ClsChannelMaster.CheckDuplicate(txtDesignationName.Text).ToString
    ...
    Protected Sub btnSave_Click(sender As Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            'obj.channelcode = HFDesignationCode.Value
            'obj.channelname = objDas.FilteredString(txtDesignationName.Text)
    ...
    Protected Sub btnDelete_Click(sender As Object, e As System.EventArgs) Handles btnDelete.Click
        Try
            'If HFDesignationCode.Value <> "" Then
            '    Dim str As String
            '    str = ClsChannelMaster.Check_Integrity(HFDesignationCode.Value).ToString.Trim
            '    If str <> "" Then
