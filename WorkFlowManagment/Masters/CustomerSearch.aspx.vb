...
Partial Class CustomerSearch
    ...
    Private Function CreateData() As SqlDataSource
        Dim selectCmnd As String = "Exec Sp_customer_GetData '','A' "
    ...
    Protected Sub btnEditEntry_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim roomName As String = DataBinder.Eval(container.DataItem, "cuscode").ToString()
        If Trim(roomName) <> "" Then
            Response.Redirect("Customer.aspx?docno=" & Trim(roomName) & "&MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
        End If
    End Sub

    Protected Sub btnAdd_Click(sender As Object, e As System.EventArgs) Handles btnAdd.Click
        Response.Redirect("Customer.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
    ...
    Private Function PrintInv(ByVal Type As String) As String
        ...
        '    report.SetParameterValue("@deptcd", Trim(ddldeptcd.SelectedValue.ToString))
        '    report.SetParameterValue("@itemcd", Trim(ddlitemcd.SelectedValue.ToString))
