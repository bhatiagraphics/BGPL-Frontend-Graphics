<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="ActionOutputMaster.aspx.vb" Inherits="ActionOutputMaster" Title="ERP" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Action Output Master</h4>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel87" runat="server">
                        <ContentTemplate>
                              ...
                              <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False" 
                                            EnableViewState="False" KeyFieldName="outputcd" 
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="0" Width="8px">
                            <DataItemTemplate>
                                <dx:ASPxButton ID="btnEditEntry" runat="server" OnClick="btnEditEntry_Click1"
                                    CssPostfix="none" RenderMode="Link" CssClass="fa fa-edit devexeditStyle">
                                </dx:ASPxButton>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Action Output Code" FieldName="outputcd" 
                                                    VisibleIndex="1" Width="200px" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Serial No." FieldName="srno" 
                                                    VisibleIndex="2" Width="100px">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Action Output Name" FieldName="outputname" 
                                                    VisibleIndex="3">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Activity Type" FieldName="acttypename" 
                                                    VisibleIndex="4">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
...
<div>
    <table>
                                ...
                                <div>
                                    <table class="auto-style1">
                                        <tr>
                                            <td colspan="6" class="Headingseparator">
                                                ...
                                                <asp:Label ID="Label240" runat="server" CssClass="EntryFormHeadingNew" 
                                                    Font-Bold="True" Font-Size="Medium" ForeColor="Black" Text="Action Output Master"></asp:Label>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label2" runat="server" CssClass="LableInterface" 
                                                    Text="Sr. No." Width="140px"></asp:Label>
                                            </td>
                                            ...
                                            <td align="left" class="style78">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtsrno" runat="server" autocomplete="off" CssClass="form-control input-sm req"
                                                                Style="margin-left: 0px; text-align: left" Width="100px"></asp:TextBox>
                                                            <asp:FilteredTextBoxExtender ID="txtqty_FilteredTextBoxExtender"
                                                                runat="server" Enabled="True" FilterType="Custom, Numbers"
                                                                TargetControlID="txtsrno" ValidChars="." />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                            </td>
                                            <td class="style79">
                                      ...
                                      <tr>
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtsrno" ErrorMessage="Enter Sr. No."></asp:RequiredFieldValidator>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="style83">
                                                <asp:Label ID="Label233" runat="server" CssClass="LableInterface" 
                                                    Text="Action Output Name" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">
                                                &nbsp;</td>
                                        
                                            <td align="left" class="style78">
                                                <asp:TextBox ID="txtoutputname" runat="server" autocomplete="off" 
                                        ...
                                        <tr> 
                                            ...
                                            <td align="left" class="style78">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtoutputname" ErrorMessage="Enter Action Output Name"></asp:RequiredFieldValidator>
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td align="right" class="style83">
                                             <asp:Label ID="Label1" runat="server" CssClass="LableInterface" 
                                                    Text="Activity Type" Width="140px"></asp:Label>
                                            </td>
                                            <td align="left" class="style83">&nbsp;</td>
                                            ...
                                            <td align="left" class="style83">
                                                ...
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlacttypecd"  Width="373px" runat="server" ValueType="System.String" CssClass="form-control searchableddl req">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                               </td>
                                          ...
                                          <tr>
                                            ...
                                            <td align="left" class="auto-style4">
                                              ...
                                              <td align="left" class="auto-style4">
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlacttypecd" ErrorMessage="Select Activity Type"></asp:RequiredFieldValidator>
                                            </td>
                                              </tr>
                                        <tr>
                                             <td class="auto-style4"></td>
                                                ...
                                                <td align="center" colspan="4" style="padding-top:12px">
                                                    <table style="width: 102%; height: 14px">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label238" runat="server" Font-Names="Arial" Font-Size="Small" ForeColor="White" Height="20px" Text="" Width="255px"></asp:Label>
                                                            </td>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                  <asp:HiddenField ID="HFoutputcd" runat="server" />
                 <asp:HiddenField ID="HFacttypecd" runat="server" />
            </ContentTemplate>
        </asp:UpdatePanel>
                </td>
            </tr>
