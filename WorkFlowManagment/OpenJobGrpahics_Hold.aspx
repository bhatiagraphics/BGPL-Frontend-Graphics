<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="OpenJobGrpahics_Hold.aspx.vb" Inherits="OpenJobGrpahics_Hold" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Approval Form Graphic (Jobs on Hold)</h4>
                </div>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto" runat="server" Theme="Metropolis" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>
...
<%--                                                            <asp:Button ID="btnSendToCustomer" runat="server" CssClass="btn btn-info  m-r-10"
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnUnHold" runat="server" CssClass="btn btn-info m-r-10"  ValidationGroup="SV"
                                                                Text="UnHold" />
