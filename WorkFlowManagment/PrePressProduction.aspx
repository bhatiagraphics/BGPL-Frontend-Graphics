<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PrePressProduction.aspx.vb" Inherits="PrePressProduction" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Prepress Form Production</h4>
                </div>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto_prepress" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>

                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlassignedto_prepress" ErrorMessage="Job Assign To"></asp:RequiredFieldValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlprintercd" ErrorMessage="Printer"></asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 nopadding_left">
                                            <label class="">Readable</label>
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlread_unread" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                            <asp:ListItem></asp:ListItem>

                                                            <asp:ListItem Value="R">Readable</asp:ListItem>
                                                            <asp:ListItem Value="U">Unreadable</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlread_unread" ErrorMessage="Readable"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtsendfor_reproduction_remark" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 nopadding_left">
                                            <div class="">
                                                <label class="">Comments Send To Customer </label>
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtcustomer_approval_remark" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnSave" ValidationGroup="SV" runat="server" CssClass="btn btn-info m-r-10"
                                                                Text="Save" />
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnSendToReproduction" runat="server" CssClass="btn btn-info m-r-10"
                                                                Text="Send To Reproduction" />

                                                        </td>

                                                        <td>
                                                            <asp:Button ID="btnSendToCustomerApproval" runat="server" CssClass="btn btn-info"
                                                                Text="Send To Customer For Approval" />
                                                        </td>
                                                        <td>
                                                            <asp:Button ID="btnhold" runat="server" CssClass="btn btn-info" ValidationGroup="SV"
                                                                Text="Hold" />
                                                        </td>
                                                        <td>
