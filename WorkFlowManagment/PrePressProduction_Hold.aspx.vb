...
Partial Class PrePressProduction_Hold
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        Try
            ...
            If Not IsNothing(obj) Then
                ...
                ddlassignedto.Items.FindByValue(Trim(obj.assignedto_prepress)).Selected = True
    ...
    Private Sub Save_Data_Add()
        ...
        Try
            ...
            obj.assignedto_prepress = ddlassignedto.SelectedValue
    ...
    Private Sub save_edit()
        ...
        If ErrorMSG.Text = "" Then
            ...
            Response.Write("window.location='PrePressProductionSearch_Hold.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
        End If
    End Sub
    ...
    Protected Sub btnUnHold_Click(sender As Object, e As System.EventArgs) Handles btnUnHold.Click
        Try
            ...
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set hold_sendforprepress_flag='',approve_sendforprepress_flag='1',approve_sendforprepress_uid='" & Trim(Session.Item("UserID")) & "',approve_sendforprepress_date=GetDate() where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
    ...
    '        Dim dt1, dt2, dt3 As DataTable
    '        Dim objDas As New DBAccess
    '        sSQL = "update jobentry set sendfor_reproduction_flag='1',sendfor_reproduction_uid='" & Trim(Session.Item("UserID")) & "',sendfor_reproduction_udate=GetDate(),sendfor_reproduction_remark='" & txtsendfor_reproduction_remark.Text & "' where jobid='" & txtjobid.Text & "'"
    '        dt1 = objDas.GetDataTable(sSQL)
    ...
    '        Dim dt1, dt2, dt3 As DataTable
    '        Dim objDas As New DBAccess
    '        'sSQL = "update jobentry set customer_approval_flag='1',customer_approval_uid='" & Trim(Session.Item("UserID")) & "',customer_approval_udate=GetDate(),customer_approval_remark='" & txtcustomer_approval_remark.Text & "' where jobid='" & txtjobid.Text & "'"
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("PrePressProductionSearch_Hold.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
