<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="OpenJobSendToCustomer.aspx.vb" Inherits="OpenJobSendToCustomer" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Approval Form(Send To Customer)</h4>
                </div>
                        ...
                        <div class="card-body" style="padding-left: 0px; padding-right: 0px">
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlprintcd" OnSelectedIndexChanged="ddlprintcd_SelectedIndexChanged"  runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                    </asp:DropDownList>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto_appformsentcustomer" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>

                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlassignedto_appformsentcustomer" ErrorMessage="Job Assign To"></asp:RequiredFieldValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <div class="form-horizontal">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="TextBox3" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                        <div class="col-md-3 nopadding_left ">
                                            <label class="">Job Send To Customer	</label>
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlsendtocustomer" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                            <asp:ListItem></asp:ListItem>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlsendtocustomer" ErrorMessage="Job Send To Customer"></asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 nopadding_left" style="">
                                            <div class="">
<%--                                                <label class="">Comments Send To Prepress</label>--%>
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtapproveremark_sendforprepress" Visible="false" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           ...
                                                           <td>
                                                            <asp:Button ID="btnAmendment" runat="server" CssClass="btn btn-info m-r-10"  ValidationGroup="sv" Visible="false"
                                                                Text="More Amendment Required" />

                                                                <asp:Button ID="btnSendToCustomerForApproval" runat="server" CssClass="btn btn-info m-r-10"  ValidationGroup="sv" 
                                                                Text="Send To Customer For Approval" />

                                                        </td>

                                                         <td>
                                                            <asp:Button ID="btnsendtopress" runat="server" CssClass="btn btn-info m-r-10"  Visible="false"
                                                                Text="Approved - Send To Prepress" />
