...
Partial Class OpenJobGrpahics
    ...
    Private Sub Fillcombo()
        Try
            ...
            dt3 = objDas.GetDataTable(sSQL)
            dt3.Rows.InsertAt(dt3.NewRow, 0)
            ddlassignedto_appformgraphic.DataSource = dt3
            ddlassignedto_appformgraphic.DataTextField = "u_name"
            ddlassignedto_appformgraphic.DataValueField = "u_id"
            ddlassignedto_appformgraphic.DataBind()
    ...
    Private Sub Refresh()
        ...
        txtintcode.Text = ""
        txtrevno.Text = ""
        ddlassignedto_appformgraphic.Text = ""
        txtticketno.Text = ""
    ...
    Protected Sub New_Docno()
        Try
            j = clsJobGraphics.Fetch_Paramno("")
            txtjobid.Text = clsJobGraphics.Generate_Docno(j, "", "").ToString.Trim
        Catch ex As Exception
            ErrorMSG.Visible = True
            ErrorMSG.Text = ""
            ErrorMSG.Text = ex.Message
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FileUpload5.Attributes("onchange") = "UploadFile5(this)"
        FileUpload6.Attributes("onchange") = "UploadFile6(this)"
        FileUpload7.Attributes("onchange") = "UploadFile7(this)"
        FileUpload8.Attributes("onchange") = "UploadFile8(this)"
        FileUpload9.Attributes("onchange") = "UploadFile9(this)"
        FileUpload10.Attributes("onchange") = "UploadFile10(this)"
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        con = clsJobGraphics.GetConnection()
        com = clsJobGraphics.GetCommand
        com.Connection = con
        com.CommandType = CommandType.Text
        Try
            Dim obj As clsJobGraphics = clsJobGraphics.FillData(geno, "B")
            If Not IsNothing(obj) Then
                ...
                ddlassignedto_appformgraphic.SelectedItem.Selected = False
                ddlassignedto_appformgraphic.Items.FindByValue(Trim(obj.assignedto_appformgraphic)).Selected = True
                ...
                ddlcan_tube.SelectedItem.Selected = False
                ddlcan_tube.Items.FindByValue(Trim(obj.can_tube)).Selected = True
                txtdiameter.Text = Trim(obj.diameter)
                txtcan_tube_height.Text = Trim(obj.can_tube_height)
                ...
                ddllabellami.SelectedItem.Selected = False
                ddllabellami.Items.FindByValue(Trim(obj.labellami)).Selected = True
                txtlabellength.Text = Trim(obj.labellength)
                txtlabelwidth.Text = Trim(obj.labelwidth)

                If Trim(obj.sento_customer_flag) = "1" Then
    ...
    Private Sub Save_Data_Add()
        ...
        Try
            Dim obj As New clsJobGraphics, objDas As New DBAccess
            ...
            obj.assignedto_appformgraphic = ddlassignedto_appformgraphic.SelectedValue
            ...
            clsJobGraphics.Update_Data_Add(obj, j, mode, "")
    ...
    Private Sub Save_Data_Edit()
        ...
        Try
            ...
            obj.can_tube = ddlcan_tube.SelectedValue
            obj.diameter = txtdiameter.Text
            obj.can_tube_height = txtcan_tube_height.Text

            obj.labellami = ddllabellami.SelectedValue
            obj.labellength = txtlabellength.Text
            obj.labelwidth = txtlabelwidth.Text
            ...
            clsJobGraphics.Update_Data_Edit(obj, j, mode, "")
    ...
    Private Sub btnSave_Click(sender As Object, e As System.EventArgs) Handles btnSave.Click
        ...
        Dim dt1, dt2, dt3 As DataTable
        Dim objDas As New DBAccess
        sSQL = "select * from fasetup"
        dt1 = objDas.GetDataTable(sSQL)
        If dt1.Rows.Count > 0 Then
            If ddlprintcd.SelectedValue = dt1.Rows(0)("letterpress").ToString Then

                'If ddllabellami.SelectedValue = "" Then
                '    Dim myscript As String = "alert('Select Label/Lami');"
                '    Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                '    Exit Sub
                'End If

                If ddllabellami.SelectedValue = "Label" Then
                    If txtlabellength.Text = "" Then
                        Dim myscript As String = "alert('Enter Label Length');"
                        Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                        Exit Sub
                    End If

                    If txtlabelwidth.Text = "" Then
                        Dim myscript As String = "alert('Enter Label Width');"
                        Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                        Exit Sub
                    End If
                ...
                If ddllabellami.SelectedValue = "Lami" Then
                    If txtdiameter.Text = "" Then
                        Dim myscript As String = "alert('Enter Diameter');"
                        Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                        Exit Sub
                    End If

                    If txtcan_tube_height.Text = "" Then
                        Dim myscript As String = "alert('Enter Tube Length');"
                        Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                        Exit Sub
                    End If
            ...
            If ddlprintcd.SelectedValue = dt1.Rows(0)("dryofset").ToString Then
                If ddlcan_tube.SelectedValue = "" Then
                    Dim myscript As String = "alert('Select Can/Tube/Seamless Tube');"
                    Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                    Exit Sub
                End If
                If txtdiameter.Text = "" Then
                ...
                If txtcan_tube_height.Text = "" Then
                    Dim myscript As String = "alert('Enter Tube/Can Length/Height');"
                    Page.ClientScript.RegisterStartupScript(Me.GetType(), "myscript", myscript, True)
                    Exit Sub
                End If
    ...
    Private Sub save_edit()
        ...
        If ErrorMSG.Text = "" Then
            ...
            Response.Write("window.location='OpenJobGrpahicsSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
        End If
    End Sub


    Protected Sub btnHold_Click(sender As Object, e As System.EventArgs) Handles btnHold.Click
        Try
            Call Save_Data_Edit()
            Dim sSQL As String
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set holdsendtographics_flag='1',sendtographics_flag='',sentographic_uid='',sentographic_dt=null  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Job is Hold'); ")
            Response.Write("window.location='OpenJobGrpahicsSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnSendToCustomer_Click(sender As Object, e As System.EventArgs) Handles btnSendToCustomer.Click
        Try
            Call Save_Data_Edit()
            Dim sSQL As String
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set sento_customer_flag='1',sento_customer_uid='" & Trim(Session.Item("UserID")) & "',sento_customer_date=GetDate(),assignedto_appformgraphic='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_appformsentcustomer='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_sendcustomerapproval='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_prepress='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_materialprod='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_qccheck='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_challan='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_appformgraphic.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Send To Customer Succesfully'); ")
            Response.Write("window.location='OpenJobGrpahicsSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("OpenJobGrpahicsSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
    ...
    Private Sub btnAmendment_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAmendment.Click
        ...
        j = clsJobGraphics.Fetch_Paramno_amd(Trim(hdnJobId.Value))
        newqtnno = clsJobGraphics.Generate_AmendDocno(j, Trim(hdnJobId.Value))

        Call clsJobGraphics.AmmendData(j, oldqtnno, newqtnno)
        ...
        Response.Redirect("OpenJobGrpahicsSearch.aspx?docno=" & Trim(newqtnno) & "&MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")


    End Sub


    Protected Sub UploadImage1(sender As Object, e As System.EventArgs)
        Dim attachmentname1, attachmentpath1 As String
        If FileUpload1.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload1.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload1.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath1)
            FileUpload1.PostedFile.SaveAs(FilePath)
            Hfattachmentname1.Value = FileName + Extension
            Hfattachmentname1.Value = attachmentname1
            Hfattachmentpath1.Value = attachmentpath1

            lblFileUpload1.Text = Trim(FileName + Extension)
        End If
    End Sub

    Protected Sub UploadImage2(sender As Object, e As System.EventArgs)
        Dim attachmentname2, attachmentpath2 As String
        If FileUpload2.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload2.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload2.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath2)
            FileUpload2.PostedFile.SaveAs(FilePath)
            Hfattachmentname2.Value = FileName + Extension
            Hfattachmentname2.Value = attachmentname2
            Hfattachmentpath2.Value = attachmentpath2
            lblFileUpload2.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage3(sender As Object, e As System.EventArgs)
        Dim attachmentname3, attachmentpath3 As String
        If FileUpload3.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload3.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload3.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath3)
            FileUpload3.PostedFile.SaveAs(FilePath)
            Hfattachmentname3.Value = FileName + Extension
            Hfattachmentname3.Value = attachmentname3
            Hfattachmentpath3.Value = attachmentpath3
            lblFileUpload3.Text = Trim(FileName + Extension)
        End If
    End Sub

    Protected Sub UploadImage4(sender As Object, e As System.EventArgs)
        Dim attachmentname4, attachmentpath4 As String
        If FileUpload4.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload4.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload4.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath4)
            FileUpload4.PostedFile.SaveAs(FilePath)
            Hfattachmentname4.Value = FileName + Extension
            Hfattachmentname4.Value = attachmentname4
            Hfattachmentpath4.Value = attachmentpath4
            lblFileUpload4.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage5(sender As Object, e As System.EventArgs)
        Dim attachmentname5, attachmentpath5 As String
        If FileUpload5.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload5.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload5.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath5)
            FileUpload5.PostedFile.SaveAs(FilePath)
            Hfattachmentname5.Value = FileName + Extension
            Hfattachmentname5.Value = attachmentname5
            Hfattachmentpath5.Value = attachmentpath5
            lblFileUpload5.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage6(sender As Object, e As System.EventArgs)
        Dim attachmentname6, attachmentpath6 As String
        If FileUpload6.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload6.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload6.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath6)
            FileUpload6.PostedFile.SaveAs(FilePath)
            Hfattachmentname6.Value = FileName + Extension
            Hfattachmentname6.Value = attachmentname6
            Hfattachmentpath6.Value = attachmentpath6
            lblFileUpload6.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage7(sender As Object, e As System.EventArgs)
        Dim attachmentname7, attachmentpath7 As String
        If FileUpload7.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload7.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload7.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath7)
            FileUpload7.PostedFile.SaveAs(FilePath)
            Hfattachmentname7.Value = FileName + Extension
            Hfattachmentname7.Value = attachmentname7
            Hfattachmentpath7.Value = attachmentpath7
            lblFileUpload7.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage8(sender As Object, e As System.EventArgs)
        Dim attachmentname8, attachmentpath8 As String
        If FileUpload8.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload8.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload8.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath8)
            FileUpload8.PostedFile.SaveAs(FilePath)
            Hfattachmentname8.Value = FileName + Extension
            Hfattachmentname8.Value = attachmentname8
            Hfattachmentpath8.Value = attachmentpath8
            lblFileUpload8.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage9(sender As Object, e As System.EventArgs)
        Dim attachmentname9, attachmentpath9 As String
        If FileUpload9.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload9.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload9.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath9)
            FileUpload9.PostedFile.SaveAs(FilePath)
            Hfattachmentname9.Value = FileName + Extension
            Hfattachmentname9.Value = attachmentname9
            Hfattachmentpath9.Value = attachmentpath9
            lblFileUpload9.Text = Trim(FileName + Extension)

        End If
    End Sub

    Protected Sub UploadImage10(sender As Object, e As System.EventArgs)
        Dim attachmentname10, attachmentpath10 As String
        If FileUpload10.HasFile Then
            Dim FileName As String = Path.GetFileNameWithoutExtension(FileUpload10.PostedFile.FileName)
            Dim Extension As String = Path.GetExtension(FileUpload10.PostedFile.FileName)
            ...
            Dim FilePath As String = Server.MapPath(attachmentpath10)
            FileUpload10.PostedFile.SaveAs(FilePath)
            Hfattachmentname10.Value = FileName + Extension
            Hfattachmentname10.Value = attachmentname10
            Hfattachmentpath10.Value = attachmentpath10
            lblFileUpload10.Text = Trim(FileName + Extension)

        End If
    End Sub


    Protected Sub ddllabellami_SelectedIndexChanged(sender As Object, e As EventArgs)
        Check()
    End Sub

    Protected Sub ddlprintcd_SelectedIndexChanged(sender As Object, e As EventArgs)
        Check()
    End Sub

    Protected Sub Check()
        lbllabellami.Visible = False
        ddllabellami.Visible = False
        txtlabellength.Visible = False
        txtlabelwidth.Visible = False
        lblleballength.Visible = False
        lbllebalwidth.Visible = False
        txtdiameter.Visible = False
        txtcan_tube_height.Visible = False
        lblDiameter.Visible = False
        lblTubeHeight.Visible = False
        lblcantube.Visible = False
        lblDiameter.Visible = False
        lblTubeHeight.Visible = False
        ddlcan_tube.Visible = False
        txtdiameter.Visible = False
        txtcan_tube_height.Visible = False
        ...
        If dt1.Rows.Count > 0 Then
            If ddlprintcd.SelectedValue = dt1.Rows(0)("letterpress").ToString Then
                lbllabellami.Visible = True
                ddllabellami.Visible = True

                If ddllabellami.SelectedValue = "Label" Then
                    txtlabellength.Visible = True
                    txtlabelwidth.Visible = True
                    lblleballength.Visible = True
                    lbllebalwidth.Visible = True

                End If

                If ddllabellami.SelectedValue = "Lami" Then
                    txtdiameter.Visible = True
                    txtcan_tube_height.Visible = True
                    lblDiameter.Visible = True
                    lblTubeHeight.Visible = True
                End If

            End If

            If ddlprintcd.SelectedValue = dt1.Rows(0)("dryofset").ToString Then
                lblcantube.Visible = True
                lblDiameter.Visible = True
                lblTubeHeight.Visible = True
                ddlcan_tube.Visible = True
                txtdiameter.Visible = True
                txtcan_tube_height.Visible = True
