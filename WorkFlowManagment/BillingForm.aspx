<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="BillingForm.aspx.vb" Inherits="BillingForm" %>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlcuscodeshipto"  runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>

                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlcuscodeshipto" ErrorMessage="Ship To"></asp:RequiredFieldValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto" Enabled ="false"   runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="col-md-12 nopadding_left">
                                            <div class="">
                                                <label class="">Billing Comments</label>
                                                <div class="">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnbillingdonejobclose" runat="server" CssClass="btn btn-info m-r-10" 
                                                                Text="Billing Done & Job Close" />
