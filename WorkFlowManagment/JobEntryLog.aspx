<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="JobEntryLog.aspx.vb" Inherits="JobEntryLog" %>
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:MaskedEditExtender ID="txtjobcreatedt_Date" Enabled="false" runat="server" Mask="99/99/9999" MaskType="Date" PromptCharacter="_" TargetControlID="txtjobcreatedt" />
                                    ...
                                    <div class="col-md-3 nopadding_left">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtjobname" Enabled="false" runat="server" autocomplete="off" CssClass="form-control input-sm req" MaxLength="60"></asp:TextBox>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtcancelremark" Enabled="false" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
