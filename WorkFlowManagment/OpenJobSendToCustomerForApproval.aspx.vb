...
Partial Class OpenJobSendToCustomerForApproval
    ...
    Private Sub Fillcombo()
        Try
            ...
            dt3 = objDas.GetDataTable(sSQL)
            dt3.Rows.InsertAt(dt3.NewRow, 0)
            ddlassignedto_sendcustomerapproval.DataSource = dt3
            ddlassignedto_sendcustomerapproval.DataTextField = "u_name"
            ddlassignedto_sendcustomerapproval.DataValueField = "u_id"
            ddlassignedto_sendcustomerapproval.DataBind()
    ...
    Private Sub Refresh()
        ...
        txtintcode.Text = ""
        txtrevno.Text = ""
        ddlassignedto_sendcustomerapproval.Text = ""
        txtticketno.Text = ""
    ...
    Protected Sub New_Docno()
        Try
            j = ClsOpenJobSendToCustomerForApproval.Fetch_Paramno("")
            txtjobid.Text = ClsOpenJobSendToCustomerForApproval.Generate_Docno(j, "", "").ToString.Trim
        Catch ex As Exception
            ErrorMSG.Visible = True
            ErrorMSG.Text = ""
            ErrorMSG.Text = ex.Message
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        con = ClsOpenJobSendToCustomerForApproval.GetConnection()
        com = ClsOpenJobSendToCustomerForApproval.GetCommand
        com.Connection = con
        com.CommandType = CommandType.Text
        Try
            Dim obj As ClsOpenJobSendToCustomerForApproval = ClsOpenJobSendToCustomerForApproval.FillData(geno, "B")
            If Not IsNothing(obj) Then
                ...
                ddlassignedto_sendcustomerapproval.SelectedItem.Selected = False
                ddlassignedto_sendcustomerapproval.Items.FindByValue(Trim(obj.assignedto_sendcustomerapproval)).Selected = True
                ...
                If Trim(obj.approve_sendforprepress_flag) = "1" Then
    ...
    Private Sub Save_Data_Add()
        Dim con As SqlConnection
        Dim com As SqlCommand
        Dim c As New ClsOpenJobSendToCustomerForApproval
        Dim i As Integer
        ...
        Try
            Dim obj As New ClsOpenJobSendToCustomerForApproval, objDas As New DBAccess
            ...
            obj.assignedto_sendcustomerapproval = ddlassignedto_sendcustomerapproval.SelectedValue
            ...
            ClsOpenJobSendToCustomerForApproval.Update_Data_Add(obj, j, mode, "")
    ...
    Private Sub Save_Data_Edit()
        ...
        Try
            ...
            ClsOpenJobSendToCustomerForApproval.Update_Data_Edit(obj, j, mode, "")
    ...
    Private Sub save_edit()
        ...
        If ErrorMSG.Text = "" Then
            ...
            Response.Write("window.location='SentToCustomerForApprovalSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
        End If
    End Sub
    ...
    Protected Sub btnSendToGrphics_Click(sender As Object, e As System.EventArgs) Handles btnsendtopress.Click
        Try
            ...
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set approve_sendforprepress_flag='1',approve_sendforprepress_uid='" & Trim(Session.Item("UserID")) & "',approve_sendforprepress_date=GetDate(),approveremark_sendforprepress='" & txtapproveremark_sendforprepress.Text & "',assignedto_sendcustomerapproval='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_prepress='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_materialprod='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_qccheck='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_challan='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_sendcustomerapproval.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("SentToCustomerForApprovalSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
    ...
    Private Sub btnAmendment_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAmendment.Click
        ...
        j = ClsOpenJobSendToCustomerForApproval.Fetch_Paramno_amd(Trim(hdnJobId.Value))
        newqtnno = ClsOpenJobSendToCustomerForApproval.Generate_AmendDocno(j, Trim(hdnJobId.Value))

        Call ClsOpenJobSendToCustomerForApproval.AmmendData(j, oldqtnno, newqtnno)
        ...
        Dim sSQL1 As String
        sSQL1 = "Update jobentry Set sendtographics_flag='1',sentographic_uid='" & Trim(Session.Item("UserID")) & "',sentographic_dt=GetDate() Where jobid='" & Trim(newqtnno) & "' "
        objDas.GetDataTable(sSQL1)

        Response.Redirect("SentToCustomerForApprovalSearch.aspx?docno=" & Trim(newqtnno) & "&MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
