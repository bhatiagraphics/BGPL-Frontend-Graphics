<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="ChallanForm.aspx.vb" Inherits="ChallanForm" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Challan</h4>
                </div>
                                    ...
                                    <div class="col-md-3 nopadding_left m-b-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlassignedto_challan" Enabled="false" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        <asp:ListItem></asp:ListItem>

                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlassignedto_challan" ErrorMessage="Job Assign To"></asp:RequiredFieldValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlcompcd" ErrorMessage="Company"></asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                       ...
                                       <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlprintercd" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req" readOnly="True" Enabled ="false" >
                                                            <asp:ListItem></asp:ListItem>
                                        ...
                                        <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlopcode" Enabled="false" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl req">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlopcode" ErrorMessage="Operator"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtlength_plate_cms" runat="server" CssClass="form-control input-sm req" MaxLength="60"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtlength_plate_cms" ErrorMessage="Length Of Plate in cms"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel26" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtwidth_plate_cms" runat="server" CssClass="form-control input-sm req" MaxLength="60"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtwidth_plate_cms" ErrorMessage="Width Of Plate in cms"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtchldt" runat="server" autocomplete="off" CssClass="form-control input-sm "></asp:TextBox>
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel32" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddltranscd" ErrorMessage="Courier"></asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
...
<%--                                        <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtbillno" runat="server" CssClass="form-control input-sm " MaxLength="60"></asp:TextBox>
                                         ...
                                         <div class="col-md-3 nopadding_left m-b-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtBilldate" runat="server" autocomplete="off" CssClass="form-control input-sm "></asp:TextBox>
                                        ...
                                        <div class="col-md-12 nopadding_left">
                                            <div class="">
                                                <label class="">Comments Send For Dispatch</label>
                                                <div class="">
                                                    <asp:UpdatePanel ID="UpdatePanel29" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtsendfor_dispatch_comments" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control input-sm req"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                                                                                <td>
                                                            <asp:Button ID="btnResetChallanInTally" runat="server" CssClass="btn btn-info m-r-10" 
                                                                Text="Reset Challan" /></td>
                                                                                                                <td>
                                                            <asp:Button ID="btnCreateInTally" runat="server" CssClass="btn btn-info m-r-10" 
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnsendToDispatch" runat="server" CssClass="btn btn-info m-r-10" 
