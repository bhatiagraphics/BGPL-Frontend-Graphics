<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="BillingFormSearch.aspx.vb" Inherits="BillingFormSearch" %>
                ...
                <div class="col-md-12 row align-self-center">
                    <div class="col-sm-10 row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            <label class="infolbl">Status</label>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlStatus" runat="server" Theme="Metropolis" AutoPostBack="true" Style="width: 100%" CssClass="form-control searchableddl ">
                            ...
                            <ContentTemplate>
                                ...
                                <dx:ASPxGridView ID="GridViewLST" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Job ID" FieldName="jobid"  HeaderStyle-Wrap ="True"
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Customer " FieldName="cusname"  HeaderStyle-Wrap ="True"
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Rev" FieldName="revno"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="5" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Priority" FieldName="prioirty"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="6" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Printing Type" FieldName="printname"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="7" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Date & Time" FieldName="jobcreatedt"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="8" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Date" FieldName="jobcreatedt1"  HeaderStyle-Wrap ="True"
                                        ...
                                        <dx:GridViewDataTextColumn Caption="No Of Plate" FieldName="noofplates"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="11" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Operator" FieldName="opname"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="12" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Length Of Plate in cms" FieldName="length_plate_cms"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="13" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Width Of Plate in cms" FieldName="width_plate_cms"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="14" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Challan No" FieldName="chlno"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="15" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Challan Date" FieldName="chldt"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="16" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Bill No" FieldName="billno"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="17" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                         <dx:GridViewDataTextColumn Caption="Bill Date" FieldName="billdt"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="18" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Assign To" FieldName="assignedname"  HeaderStyle-Wrap ="True"
                                            VisibleIndex="19" Width="350px">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </dx:GridViewDataTextColumn>
