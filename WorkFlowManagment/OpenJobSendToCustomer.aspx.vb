...
Partial Class OpenJobSendToCustomer
    ...
    Private Sub Fillcombo()
        Try
            ...
            dt3 = objDas.GetDataTable(sSQL)
            dt3.Rows.InsertAt(dt3.NewRow, 0)
            ddlassignedto_appformsentcustomer.DataSource = dt3
            ddlassignedto_appformsentcustomer.DataTextField = "u_name"
            ddlassignedto_appformsentcustomer.DataValueField = "u_id"
            ddlassignedto_appformsentcustomer.DataBind()
    ...
    Private Sub Refresh()
        ...
        txtintcode.Text = ""
        txtrevno.Text = ""
        ddlassignedto_appformsentcustomer.Text = ""
        txtticketno.Text = ""
    ...
    Protected Sub New_Docno()
        Try
            j = clsJobSendToCustomer.Fetch_Paramno("")
            txtjobid.Text = clsJobSendToCustomer.Generate_Docno(j, "", "").ToString.Trim
        Catch ex As Exception
            ErrorMSG.Visible = True
            ErrorMSG.Text = ""
            ErrorMSG.Text = ex.Message
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        con = clsJobSendToCustomer.GetConnection()
        com = clsJobSendToCustomer.GetCommand
        com.Connection = con
        com.CommandType = CommandType.Text
        Try
            Dim obj As clsJobSendToCustomer = clsJobSendToCustomer.FillData(geno, "B")
            If Not IsNothing(obj) Then
                ...
                ddlassignedto_appformsentcustomer.SelectedItem.Selected = False
                ddlassignedto_appformsentcustomer.Items.FindByValue(Trim(obj.assignedto_appformsentcustomer)).Selected = True
                ...
                ddlsendtocustomer.SelectedItem.Selected = False
                ddlsendtocustomer.Items.FindByValue(Trim(obj.jobsentcustomer_forapproval)).Selected = True

                txtapproveremark_sendforprepress.Text = Trim(obj.approveremark_sendforprepress)
                ...
                If Trim(obj.approve_sendtocustomerforapprval_flag) = "1" Then
                    btnAmendment.Visible = False
                    btnsendtopress.Visible = False
                    btnSendToCustomerForApproval.Visible = False
                    btnSave.Visible = False
                    btnSave.Visible = False
                End If
    ...
    Private Sub Save_Data_Add()
        Dim con As SqlConnection
        Dim com As SqlCommand
        Dim c As New clsJobSendToCustomer
        Dim i As Integer
        ...
        Try
            Dim obj As New clsJobSendToCustomer, objDas As New DBAccess
            ...
            obj.assignedto_appformsentcustomer = ddlassignedto_appformsentcustomer.SelectedValue
            ...
            clsJobSendToCustomer.Update_Data_Add(obj, j, mode, "")
    ...
    Private Sub Save_Data_Edit()
        ...
        Try
            ...
            obj.jobsentcustomer_forapproval = ddlsendtocustomer.SelectedValue
            ...
            clsJobSendToCustomer.Update_Data_Edit(obj, j, mode, "")
    ...
    Private Sub save_edit()
        ...
        If ErrorMSG.Text = "" Then
            ...
            Response.Write("window.location='OpenJobSendToCustomerSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
        End If
    End Sub
    ...
    Protected Sub btnSendToGrphics_Click(sender As Object, e As System.EventArgs) Handles btnsendtopress.Click
        Try
            Call Save_Data_Edit()
            Dim sSQL As String
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set approve_sendforprepress_flag='1',approve_sendforprepress_uid='" & Trim(Session.Item("UserID")) & "',approve_sendforprepress_date=GetDate(),approveremark_sendforprepress='" & txtapproveremark_sendforprepress.Text & "'assignedto_appformsentcustomer='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "' where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Sent To Prepress Succesfully'); ")
            Response.Write("window.location='OpenJobSendToCustomerSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnSendToCustomerForApproval_Click(sender As Object, e As System.EventArgs) Handles btnSendToCustomerForApproval.Click
        Try
            Call Save_Data_Edit()
            Dim sSQL As String
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set approve_sendtocustomerforapprval_flag='1',approve_sendtocustomerforapprval_uid='" & Trim(Session.Item("UserID")) & "',approve_sendtocustomerforapprval_date=GetDate(),assignedto_appformsentcustomer='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_sendcustomerapproval='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_prepress='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_materialprod='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_qccheck='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_challan='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_appformsentcustomer.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Sent To Customer For Approval Succesfully'); ")
            Response.Write("window.location='OpenJobSendToCustomerSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("OpenJobSendToCustomerSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
    ...
    Private Sub btnAmendment_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAmendment.Click
        ...
        j = clsJobSendToCustomer.Fetch_Paramno_amd(Trim(hdnJobId.Value))
        newqtnno = clsJobSendToCustomer.Generate_AmendDocno(j, Trim(hdnJobId.Value))

        Call clsJobSendToCustomer.AmmendData(j, oldqtnno, newqtnno)
        ...
        Response.Redirect("OpenJobSendToCustomerSearch.aspx?docno=" & Trim(newqtnno) & "&MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
