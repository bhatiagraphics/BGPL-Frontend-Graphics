...
Partial Class QC
    ...
    Private Sub Fillcombo()
        Try
            ...
            dt3 = objDas.GetDataTable(sSQL)
            dt3.Rows.InsertAt(dt3.NewRow, 0)
            ddlassignedto_qccheck.DataSource = dt3
            ddlassignedto_qccheck.DataTextField = "u_name"
            ddlassignedto_qccheck.DataValueField = "u_id"
            ddlassignedto_qccheck.DataBind()
    ...
    Private Sub Refresh()
        ...
        txtnoofplates.Text = ""
        ddlopcode.Text = ""
        ddlassignedto_qccheck.Text = ""

    End Sub

    Protected Sub New_Docno()
        Try
            j = clsJobQc.Fetch_Paramno("")
            txtjobid.Text = clsJobQc.Generate_Docno(j, "", "").ToString.Trim
        Catch ex As Exception
            ErrorMSG.Visible = True
            ErrorMSG.Text = ""
            ErrorMSG.Text = ex.Message
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        con = clsJobQc.GetConnection()
        com = clsJobQc.GetCommand
        com.Connection = con
        com.CommandType = CommandType.Text
        Try
            Dim obj As clsJobQc = clsJobQc.FillData(geno, "B")
            If Not IsNothing(obj) Then
                ...
                ddlassignedto_qccheck.SelectedItem.Selected = False
                ddlassignedto_qccheck.Items.FindByValue(Trim(obj.assignedto_qccheck)).Selected = True
                ...
                txtsenfor_billing_comments.Text = Trim(obj.senfor_billing_comments)
                ...
                If Trim(obj.sendfor_billing_flag) = "1" Then
    ...
    Private Sub Save_Data_Add()
        ...
        Try
            Dim obj As New clsJobQc, objDas As New DBAccess
            ...
            obj.assignedto_qccheck = ddlassignedto_qccheck.SelectedValue
            ...
            clsJobQc.Update_Data_Add(obj, j, mode, "")
    ...
    Private Sub Save_Data_Edit()
        ...
        Try
            ...
            obj.noofplates = Trim(txtnoofplates.Text)
            ...
            obj.senfor_billing_comments = Trim(txtsenfor_billing_comments.Text)
            ...
            clsJobQc.Update_Data_Edit(obj, j, mode, "")
    ...
    Protected Sub btnSendToGrphics_Click(sender As Object, e As System.EventArgs) Handles btnSendForQC.Click
        Try
            ...
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set sendfor_challan_flag='1',sendfor_challan_uid='" & Trim(Session.Item("UserID")) & "',sendfor_challan_date=GetDate(),assignedto_challan='" & Trim(ddlassignedto_qccheck.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_qccheck.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_qccheck.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("QCSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
