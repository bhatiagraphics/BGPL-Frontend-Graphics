...
Partial Class MaterialProductionNew
    ...
    Private Sub Fillcombo()
        Try
            ...
            dt3 = objDas.GetDataTable(sSQL)
            dt3.Rows.InsertAt(dt3.NewRow, 0)
            ddlassignedto_materialprod.DataSource = dt3
            ddlassignedto_materialprod.DataTextField = "u_name"
            ddlassignedto_materialprod.DataValueField = "u_id"
            ddlassignedto_materialprod.DataBind()
    ...
    Private Sub Refresh()
        ...
        txtintcode.Text = ""
        txtrevno.Text = ""
        ddlassignedto_materialprod.Text = ""
        txtticketno.Text = ""
    ...
    Protected Sub New_Docno()
        Try
            j = clsJobMaaterialProduction.Fetch_Paramno("")
            txtjobid.Text = clsJobMaaterialProduction.Generate_Docno(j, "", "").ToString.Trim
        Catch ex As Exception
            ErrorMSG.Visible = True
            ErrorMSG.Text = ""
            ErrorMSG.Text = ex.Message
    ...
    Private Sub DisplayData(ByVal geno As String)
        ...
        con = clsJobMaaterialProduction.GetConnection()
        com = clsJobMaaterialProduction.GetCommand
        com.Connection = con
        com.CommandType = CommandType.Text
        Try
            Dim obj As clsJobMaaterialProduction = clsJobMaaterialProduction.FillData(geno, "B")
            If Not IsNothing(obj) Then
                ...
                ddlassignedto_materialprod.SelectedItem.Selected = False
                ddlassignedto_materialprod.Items.FindByValue(Trim(obj.assignedto_materialprod)).Selected = True
                ...
                ddlisjob_taken_abalation.SelectedItem.Selected = False
                ddlisjob_taken_abalation.Items.FindByValue(Trim(obj.isjob_taken_abalation)).Selected = True

                txtjobtaken_abalation_comments.Text = Trim(obj.jobtaken_abalation_comments)
                ...
                If Trim(obj.qc_check_flag) = "1" Then
                    btnSendForQC.Visible = False
                    btnSendForChallan.Visible = False
                    btnSave.Visible = False
                    btnSave.Visible = False
                End If
    ...
    Private Sub Save_Data_Add()
        Dim con As SqlConnection
        Dim com As SqlCommand
        Dim c As New clsJobMaaterialProduction
        Dim i As Integer
        ...
        Try
            Dim obj As New clsJobMaaterialProduction, objDas As New DBAccess
            ...
            obj.assignedto_materialprod = ddlassignedto_materialprod.SelectedValue
            ...
            clsJobMaaterialProduction.Update_Data_Add(obj, j, mode, "")
    ...
    Private Sub Save_Data_Edit()
        ...
        Try
            ...
            obj.isjob_taken_abalation = ddlisjob_taken_abalation.SelectedValue
            obj.jobtaken_abalation_comments = Trim(txtjobtaken_abalation_comments.Text)
            ...
            clsJobMaaterialProduction.Update_Data_Edit(obj, j, mode, "")
    ...
    Private Sub save_edit()
        ...
        If ErrorMSG.Text = "" Then
            ...
            Response.Write("window.location='MaterialProductionSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
        End If
    End Sub

    Protected Sub btnSendForChallan_Click(sender As Object, e As System.EventArgs) Handles btnSendForChallan.Click
        Try
            Call Save_Data_Edit()
            Dim sSQL As String
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set sendfor_challan_flag='1',sendfor_challan_uid='" & Trim(Session.Item("UserID")) & "',sendfor_challan_date=GetDate(),assignedto_materialprod='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_qccheck='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_challan='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_materialprod.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Send For Challan Succesfully'); ")
            Response.Write("window.location='MaterialProductionSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnSendToGrphics_Click(sender As Object, e As System.EventArgs) Handles btnSendForQC.Click
        Try
            ...
            Dim dt1, dt2, dt3 As DataTable
            Dim objDas As New DBAccess
            sSQL = "update jobentry set qc_check_flag='1',qc_check_uid='" & Trim(Session.Item("UserID")) & "',qc_check_date=GetDate(), assignedto_materialprod='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_qccheck='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_challan='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_dispatch='" & Trim(ddlassignedto_materialprod.SelectedValue) & "',assignedto_billing='" & Trim(ddlassignedto_materialprod.SelectedValue) & "'  where jobid='" & txtjobid.Text & "'"
            dt1 = objDas.GetDataTable(sSQL)
            Response.Write("<script>alert('Send For QC Succesfully'); ")
            Response.Write("window.location='MaterialProductionSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "'</script>")
    ...
    Protected Sub btnClose_Click(sender As Object, e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("MaterialProductionSearch.aspx?MMModuleid=" & Trim(Request.QueryString("MMModuleid")) & "&mainid=" & Trim(Request.QueryString("mainid")) & "&subid=" & Trim(Request.QueryString("subid")) & "")
    End Sub
