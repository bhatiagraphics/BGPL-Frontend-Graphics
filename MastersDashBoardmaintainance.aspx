<%@ Page Title="ERP" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="MastersDashBoardmaintainance.aspx.vb" Inherits="MastersDashBoardmaintainance" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Maintenance - Masters	 	 </h4>
                </div>
                ...
                <tr>
                    <td align="center">
                        <table style="width: 50%;">
                            ...
                            <tr>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink6124" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Equipment Master</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink6125" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Breakdown Nature</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
