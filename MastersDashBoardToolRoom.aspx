<%@ Page Title="ERP" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="MastersDashBoardToolRoom.aspx.vb" Inherits="MastersDashBoardToolRoom" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">ToolRoom - Masters	 	 </h4>
                </div>
                    ...
                    <td align="center">
                       <table style="width: 50%;">
                           <%-- <tr>
                            ...
                            <tr>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink6124" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Process Master</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt;Sub Process Master</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt;Mould Master</asp:HyperLink>
                          ...
                          <%--   <tr>
                           ...
                           <tr>
                               ...
                               <td>&nbsp;</td>
                               <td align="left">
                                   <asp:Label ID="Label712" runat="server" ForeColor="#DFDFDF" Text="---------------------------------" Width="100%"></asp:Label>
                               </td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                               <td align="left">
                                   <asp:Label ID="Label713" runat="server" ForeColor="#DFDFDF" Text="---------------------------------" Width="100%"></asp:Label>
                               </td>
                           </tr>
                           <tr>
                               <td align="left">
                                   <asp:HyperLink ID="HyperLink6125" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Machine</asp:HyperLink>
                               </td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                               <td align="left">
                                   <asp:HyperLink ID="HyperLink6126" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Product</asp:HyperLink>
                               </td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
                               <td>&nbsp;</td>
