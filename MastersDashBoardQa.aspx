<%@ Page Title="ERP" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="MastersDashBoardQa.aspx.vb" Inherits="MastersDashBoardQa" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">QA - Masters	 	 </h4>
                </div>
                ...
                <tr>
                    <td align="center">
                        <table >
                            ...
                            <tr>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink6124" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Reject Reason Master</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
