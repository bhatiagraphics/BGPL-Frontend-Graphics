<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Dashboard_chart_Product.aspx.vb" Inherits="Dashboard_chart_Product" %>
...
//         function LoadChart() {
             $(function () {
                 ...
                 $.ajax({
                     ...
                     url: 'Dashboard_chart_Product.aspx/GetChartData',
                     success:
                        function (response) {
    ...
    <table style="width:100%;">
                <tr>
                    <td align="center">
                            ...
                            <div id="pie" style="height:340px;"></div>
