<%@ Page Title="ERP" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="ReportDashBoardToolRoom.aspx.vb" Inherits="ReportDashBoardToolRoom" %>
        ...
        <div class="col-12">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">ToolRoom - Reports	 	 </h4>
                </div>
                ...
                <tr>
                    <td align="center">
                         <table >
                            ...
                            <tr>
                                <td align="left">
                                   <asp:HyperLink ID="HyperLink1" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Planning Report</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td align="left">
<%--                                   <asp:HyperLink ID="HyperLink1" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Moul Production Process Report</asp:HyperLink>--%>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
...
<%--                                    <asp:Label ID="Label723" runat="server" ForeColor="#DFDFDF" Text="------------------------------------------------------------" Width="100%"></asp:Label>--%>
                            ...
                            <tr>
                                <td align="left">
                                   <asp:HyperLink ID="HyperLink2" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Production Process Report</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
...
<%--                                    <asp:HyperLink ID="HyperLink411" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Grinder Register</asp:HyperLink>--%>
                                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Master List</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
...
<%--                                    <asp:HyperLink ID="HyperLink6126" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Consumption Register</asp:HyperLink>--%>
                                    <asp:HyperLink ID="HyperLink4" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Mould Product List</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
...
<%--                                    <asp:HyperLink ID="HyperLink6128" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Export Dispatch Planning Report</asp:HyperLink>--%>
                                    <asp:HyperLink ID="HyperLink5" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Job Sheet Report</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
...
<%--                                    <asp:Label ID="Label728" runat="server" ForeColor="#DFDFDF" Text="------------------------------------------------------------" Width="100%"></asp:Label>--%>
                            ...
                            <tr>
                                <td align="left">
                                    <asp:HyperLink ID="HyperLink6" runat="server" CssClass="EntryFormHeadingNew" Font-Bold="False" Font-Size="10pt" Font-Underline="False" ForeColor="#609ED2">&gt; Project Timeline Report</asp:HyperLink>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
