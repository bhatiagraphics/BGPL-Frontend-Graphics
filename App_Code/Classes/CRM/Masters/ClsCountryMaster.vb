...
Namespace FOODERPWEB.Class
    Public Class ClsCountryMaster
        ...
        Public Shared Function FillData(ByVal countrycd As String, ByVal Flag As String) As ClsCountryMaster
            Try
                Dim db As DBAccess = New DBAccess
                db.Parameters.Add(New SqlParameter("@countrycd", countrycd))
                db.Parameters.Add(New SqlParameter("@Flag", Flag))

                Dim dt As DataTable = db.ExecuteDataTable("Sp_country_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As ClsCountryMaster = New ClsCountryMaster
        ...
        Public Shared Function GetDataAll(ByVal countrycd As String, ByVal Flag As String) As DataTable
            Try
                Dim db As DBAccess = New DBAccess
                db.Parameters.Add(New SqlParameter("@countrycd", countrycd))
                db.Parameters.Add(New SqlParameter("@Flag", Flag))
        ...
        Public Shared Function GetDocCode() As String
            Try
                ...
                sSQL = "SELECT MAX(cast(countrycd as Integer)) AS countrycd FROM country"
                dt = objDas.GetDataTable(sSQL)
                If dt.Rows.Count > 0 Then
                    If Not IsDBNull(dt.Rows(0).Item("countrycd")) Then
                        If dt.Rows(0).Item("countrycd").ToString <> "" Then
                            GetDocCode = dt.Rows(0)("countrycd").ToString + 1
                        Else
                            GetDocCode = 1
                        End If
                    Else
        ...
        Public Shared Function Update_Data(ByVal o As ClsCountryMaster, ByVal mode As String) As Integer
            ...
            End If
            Com1.Parameters.Add(New SqlParameter("@countryname", o.countryname))
        ...
        Public Shared Function Delete(ByVal o As ClsCountryMaster) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim Com1 As SqlCommand
            Dim Ssql1 As String
        ...
        Public Shared Function Check_Integrity(ByVal strcode As String) As String
            ...
            com.CommandText = "CheckIntegrity_country_Sp"
