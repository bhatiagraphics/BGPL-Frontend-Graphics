...
Namespace FOODERPWEB.Class
    Public Class clsBillingForm
        ...
        Private mcuscodeshipto As String
        ...
        Public Property cuscodeshipto() As String
            Get
                Return mcuscodeshipto
            End Get
            Set(ByVal value As String)
                mcuscodeshipto = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsBillingForm
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_billing", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobBilling_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsBillingForm = New clsBillingForm
                    ...
                    obj.assignedto = dt.Rows(0)("assignedto_billing").ToString
                    ...
                    obj.cuscodeshipto = dt.Rows(0)("cuscodeshipto").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsBillingForm, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsBillingForm, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_billing", o.assignedto))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Com1.Parameters.Add(New SqlParameter("@cuscodeshipto", o.cuscodeshipto))
            Com1.Parameters.Add(New SqlParameter("@compcd", o.compcd))
        ...
        Public Shared Function Delete(ByVal o As clsBillingForm) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
