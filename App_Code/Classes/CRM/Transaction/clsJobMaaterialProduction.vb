...
Namespace FOODERPWEB.Class
    Public Class clsJobMaaterialProduction
        ...
        Private massignedto_materialprod As String
        ...
        Private misjob_taken_abalation As String
        Private mjobtaken_abalation_comments As String

        Private mcancelflag As String
        Private mcanceluserid As String
        Private mcanceldt As String
        Private mqc_check_flag As String
        Private msendfor_reproduction_remark As String
        ...
        Public Property sendfor_reproduction_remark() As String
            Get
                Return msendfor_reproduction_remark
            End Get
            Set(ByVal value As String)
                msendfor_reproduction_remark = value
            End Set
        End Property

        Public Property qc_check_flag() As String
            Get
                Return mqc_check_flag
            End Get
            Set(ByVal value As String)
                mqc_check_flag = value
            End Set
        End Property
        ...
        Public Property canceluserid() As String
            Get
                Return mcanceluserid
            End Get
            Set(ByVal value As String)
                mcanceluserid = value
            End Set
        ...
        Public Property canceldt() As String
            Get
                Return mcanceldt
            End Get
            Set(ByVal value As String)
        ...
        Public Property isjob_taken_abalation() As String
            Get
                Return misjob_taken_abalation
            End Get
            Set(ByVal value As String)
                misjob_taken_abalation = value
            End Set
        End Property

        Public Property jobtaken_abalation_comments() As String
            Get
                Return mjobtaken_abalation_comments
            End Get
            Set(ByVal value As String)
                mjobtaken_abalation_comments = value
            End Set
        End Property
        ...
        Public Property assignedto_materialprod() As String
            Get
                Return massignedto_materialprod
            End Get
            Set(ByVal value As String)
                massignedto_materialprod = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobMaaterialProduction
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_materialprod", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobJobaterialproduction_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobMaaterialProduction = New clsJobMaaterialProduction
                    ...
                    obj.assignedto_materialprod = dt.Rows(0)("assignedto_materialprod").ToString
                    ...
                    obj.isjob_taken_abalation = dt.Rows(0)("isjob_taken_abalation").ToString
                    obj.jobtaken_abalation_comments = dt.Rows(0)("jobtaken_abalation_comments").ToString
                    obj.cancelflag = dt.Rows(0)("cancelflag").ToString
                    obj.qc_check_flag = dt.Rows(0)("qc_check_flag").ToString

                    obj.sendfor_reproduction_remark = dt.Rows(0)("sendfor_reproduction_remark").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobMaaterialProduction, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_materialprod))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobMaaterialProduction, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_materialprod", o.assignedto_materialprod))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Com1.Parameters.Add(New SqlParameter("@isjob_taken_abalation", o.isjob_taken_abalation))
            Com1.Parameters.Add(New SqlParameter("@jobtaken_abalation_comments", o.jobtaken_abalation_comments))
            Com1.Parameters.Add(New SqlParameter("@cancelflag", o.cancelflag))
            Com1.Parameters.Add(New SqlParameter("@canceluserid", o.canceluserid))
            Com1.Parameters.Add(New SqlParameter("@canceldt", o.canceldt))
            ...
            Ssql1 = "Sp_jobaterialproduction_AE"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function Delete(ByVal o As clsJobMaaterialProduction) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
