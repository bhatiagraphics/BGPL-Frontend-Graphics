...
Namespace FOODERPWEB.Class
    Public Class clsJobSendToCustomer
        ...
        Private massignedto_appformsentcustomer As String
        ...
        Private mcan_tube As String
        Private mdiameter As String
        Private mcan_tube_height As String
        Private mjobsentcustomer_forapproval As String
        Private mapproveremark_sendforprepress As String
        Private mapprove_sendforprepress_flag As String

        Private mlabellami As String
        Private mLabelLength As String
        Private mlabelwidth As String

        Private mapprove_sendtocustomerforapprval_flag As String
        ...
        Public Property approve_sendtocustomerforapprval_flag() As String
            Get
                Return mapprove_sendtocustomerforapprval_flag
            End Get
            Set(ByVal value As String)
                mapprove_sendtocustomerforapprval_flag = value
            End Set
        End Property

        Public Property labellami() As String
            Get
                Return mlabellami
            End Get
            Set(ByVal value As String)
        ...
        Public Property labellength() As String
            Get
                Return mLabelLength
            End Get
            Set(ByVal value As String)
        ...
        Public Property approve_sendforprepress_flag() As String
            Get
                Return mapprove_sendforprepress_flag
            End Get
            Set(ByVal value As String)
                mapprove_sendforprepress_flag = value
            End Set
        End Property

        Public Property approveremark_sendforprepress() As String
            Get
                Return mapproveremark_sendforprepress
            End Get
            Set(ByVal value As String)
                mapproveremark_sendforprepress = value
            End Set
        End Property

        Public Property jobsentcustomer_forapproval() As String
            Get
                Return mjobsentcustomer_forapproval
            End Get
            Set(ByVal value As String)
                mjobsentcustomer_forapproval = value
            End Set
        End Property

        Public Property can_tube() As String
            Get
                Return mcan_tube
            End Get
            Set(ByVal value As String)
        ...
        Public Property can_tube_height() As String
            Get
                Return mcan_tube_height
            End Get
            Set(ByVal value As String)
                mcan_tube_height = value
            End Set
        End Property
        ...
        Public Property assignedto_appformsentcustomer() As String
            Get
                Return massignedto_appformsentcustomer
            End Get
            Set(ByVal value As String)
                massignedto_appformsentcustomer = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobSendToCustomer
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_appformsentcustomer", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobJobsendcustomer_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobSendToCustomer = New clsJobSendToCustomer
                    ...
                    obj.assignedto_appformsentcustomer = dt.Rows(0)("assignedto_appformsentcustomer").ToString
                    ...
                    obj.labellami = dt.Rows(0)("labellami").ToString
                    obj.labellength = dt.Rows(0)("labellength").ToString
                    obj.labelwidth = dt.Rows(0)("labelwidth").ToString

                    obj.can_tube = dt.Rows(0)("can_tube").ToString
                    obj.diameter = dt.Rows(0)("diameter").ToString
                    obj.can_tube_height = dt.Rows(0)("can_tube_height").ToString
                    obj.jobsentcustomer_forapproval = dt.Rows(0)("jobsentcustomer_forapproval").ToString
                    obj.approveremark_sendforprepress = dt.Rows(0)("approveremark_sendforprepress").ToString
                    obj.approve_sendforprepress_flag = dt.Rows(0)("approve_sendforprepress_flag").ToString
                    obj.approve_sendtocustomerforapprval_flag = dt.Rows(0)("approve_sendtocustomerforapprval_flag").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobSendToCustomer, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_appformsentcustomer))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobSendToCustomer, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformsentcustomer", o.assignedto_appformsentcustomer))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Com1.Parameters.Add(New SqlParameter("@link5", o.link5))
            Com1.Parameters.Add(New SqlParameter("@customerinstruction", o.customerinstruction))
            Com1.Parameters.Add(New SqlParameter("@can_tube", o.can_tube))
            Com1.Parameters.Add(New SqlParameter("@diameter", o.diameter))
            Com1.Parameters.Add(New SqlParameter("@can_tube_height", o.can_tube_height))
            Com1.Parameters.Add(New SqlParameter("@jobsentcustomer_forapproval", o.jobsentcustomer_forapproval))

            Com1.Parameters.Add(New SqlParameter("@labellami", o.labellami))
            Com1.Parameters.Add(New SqlParameter("@labellength", o.labellength))
            Com1.Parameters.Add(New SqlParameter("@labelwidth", o.labelwidth))
            ...
            Ssql1 = "Sp_jobentrysendcustomer_AE"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function Delete(ByVal o As clsJobSendToCustomer) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
        ...
        Public Shared Function Fetch_Paramno_amd(ByVal qtnno As String) As Integer
            Dim con As SqlConnection
            Dim com As SqlCommand
            Dim DOCTYPE, DOCCODE As String
            Dim p As Integer
            ...
            com.Connection = con
            com.CommandType = CommandType.Text
            com.CommandText = "select max(isnull(jobversion,0)) from jobentry where originaljobid='" & qtnno & "'"
        ...
        Public Shared Function AmmendData(ByVal paramno As Integer, ByVal oldJobId As String, ByVal JobId As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@OrignalJobId", oldJobId))
            Com1.Parameters.Add(New SqlParameter("@jobversion", paramno))
            Com1.Parameters.Add(New SqlParameter("@JobId", JobId))


            Ssql1 = "Sp_jobentryAmend_AE"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function Generate_AmendDocno(ByVal paramno As Integer, ByVal docno As String)
            Try
                Dim startyr, endyr, doccode As String
                Dim docsrno As String
                'ccode = DBAccess.CmpCode
                ...
                docsrno = DocumentSrno(paramno, 2)

                Generate_AmendDocno = Trim(docno) & "-" & Trim(docsrno)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
