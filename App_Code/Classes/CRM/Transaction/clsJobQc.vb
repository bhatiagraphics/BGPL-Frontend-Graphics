...
Namespace FOODERPWEB.Class
    Public Class clsJobQc
        ...
        Private massignedto_qccheck As String
        ...
        Public Property sendfor_billing_flag() As String
            Get
                Return msendfor_billing_flag
            End Get
            Set(ByVal value As String)
                msendfor_billing_flag = value
            End Set
        End Property
        ...
        Public Property senfor_billing_comments() As String
            Get
                Return msenfor_billing_comments
            End Get
            Set(ByVal value As String)
                msenfor_billing_comments = value
            End Set
        End Property
        ...
        Public Property assignedto_qccheck() As String
            Get
                Return massignedto_qccheck
            End Get
            Set(ByVal value As String)
                massignedto_qccheck = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobQc
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_qccheck", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobJobqc_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobQc = New clsJobQc
                    ...
                    obj.assignedto_qccheck = dt.Rows(0)("assignedto_qccheck").ToString
                    ...
                    obj.senfor_billing_comments = dt.Rows(0)("senfor_billing_comments").ToString
                    obj.cancelflag = dt.Rows(0)("cancelflag").ToString
                    obj.sendfor_billing_flag = dt.Rows(0)("sendfor_billing_flag").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobQc, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_qccheck))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobQc, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_qccheck", o.assignedto_qccheck))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
        ...
        Public Shared Function Delete(ByVal o As clsJobQc) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
