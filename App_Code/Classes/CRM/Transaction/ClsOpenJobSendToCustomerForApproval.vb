...
Namespace FOODERPWEB.Class
    Public Class ClsOpenJobSendToCustomerForApproval
        ...
        Private massignedto_sendcustomerapproval As String
        ...
        Public Property assignedto_sendcustomerapproval() As String
            Get
                Return massignedto_sendcustomerapproval
            End Get
            Set(ByVal value As String)
                massignedto_sendcustomerapproval = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As ClsOpenJobSendToCustomerForApproval
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_sendcustomerapproval", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobJobsendcustomerApproval_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As ClsOpenJobSendToCustomerForApproval = New ClsOpenJobSendToCustomerForApproval
                    ...
                    obj.assignedto_sendcustomerapproval = dt.Rows(0)("assignedto_sendcustomerapproval").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As ClsOpenJobSendToCustomerForApproval, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_sendcustomerapproval))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As ClsOpenJobSendToCustomerForApproval, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_sendcustomerapproval", o.assignedto_sendcustomerapproval))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Ssql1 = "Sp_jobentrysendcustomerApproval_AE"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function Delete(ByVal o As ClsOpenJobSendToCustomerForApproval) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
