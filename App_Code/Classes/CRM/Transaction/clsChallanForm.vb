...
Namespace FOODERPWEB.Class
    Public Class clsChallanForm
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsChallanForm
            Try
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobChallan_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsChallanForm = New clsChallanForm
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsChallanForm, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsChallanForm, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Delete(ByVal o As clsChallanForm) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
