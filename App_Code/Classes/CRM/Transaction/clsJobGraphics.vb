...
Namespace FOODERPWEB.Class
    Public Class clsJobGraphics
        ...
        Private massignedto_appformgraphic As String
        ...
        Private msento_customer_flag As String
        ...
        Public Property sento_customer_flag() As String
            Get
                Return msento_customer_flag
            End Get
            Set(ByVal value As String)
                msento_customer_flag = value
            End Set
        End Property
        ...
        Public Property assignedto_appformgraphic() As String
            Get
                Return massignedto_appformgraphic
            End Get
            Set(ByVal value As String)
                massignedto_appformgraphic = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobGraphics
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobentryGRAPHCIS_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobGraphics = New clsJobGraphics
                    ...
                    obj.assignedto_appformgraphic = dt.Rows(0)("assignedto_appformgraphic").ToString
                    ...
                    obj.sento_customer_flag = dt.Rows(0)("sento_customer_flag").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobGraphics, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_appformgraphic))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobGraphics, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Delete(ByVal o As clsJobGraphics) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
