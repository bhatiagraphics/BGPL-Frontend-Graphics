...
Namespace FOODERPWEB.Class
    Public Class clsJobSendToPrePressProduction
        ...
        Private massignedto_prepress As String
        ...
        Private mread_unread As String

        Private msendfor_reproduction_remark As String
        Private mcustomer_approval_remark As String
        Private msendfor_reproduction_flag As String
        ...
        Public Property sendfor_reproduction_flag() As String
            Get
                Return msendfor_reproduction_flag
            End Get
            Set(ByVal value As String)
                msendfor_reproduction_flag = value
            End Set
        End Property
        ...
        Public Property customer_approval_remark() As String
            Get
                Return mcustomer_approval_remark
            End Get
            Set(ByVal value As String)
                mcustomer_approval_remark = value
            End Set
        End Property
        ...
        Public Property read_unread() As String
            Get
                Return mread_unread
            End Get
            Set(ByVal value As String)
        ...
        Public Property assignedto_prepress() As String
            Get
                Return massignedto_prepress
            End Get
            Set(ByVal value As String)
                massignedto_prepress = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobSendToPrePressProduction
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_prepress", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobJobprepressprod_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobSendToPrePressProduction = New clsJobSendToPrePressProduction
                    ...
                    obj.assignedto_prepress = dt.Rows(0)("assignedto_prepress").ToString
                    ...
                    obj.read_unread = dt.Rows(0)("read_unread").ToString
                    obj.sendfor_reproduction_remark = dt.Rows(0)("sendfor_reproduction_remark").ToString
                    obj.customer_approval_remark = dt.Rows(0)("customer_approval_remark").ToString
                    obj.sendfor_reproduction_flag = dt.Rows(0)("sendfor_reproduction_flag").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobSendToPrePressProduction, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_prepress))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobSendToPrePressProduction, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_prepress", o.assignedto_prepress))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Com1.Parameters.Add(New SqlParameter("@read_unread", o.read_unread))
            Com1.Parameters.Add(New SqlParameter("@plate_processed_date", o.plate_processed_date))
        ...
        Public Shared Function Delete(ByVal o As clsJobSendToPrePressProduction) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
