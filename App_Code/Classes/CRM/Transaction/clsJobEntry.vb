...
Namespace FOODERPWEB.Class
    Public Class clsJobEntry
        ...
        Private mcancelflag As String
        Private mcancelremark As String
        Private mdispatch_close_flag As String

        Private msendtographics_flag As String
        Private msentographic_uid As String
        Private msentographic_dt As String

        Private mapprove_sendforprepress_flag As String
        Private mapprove_sendforprepress_uid As String
        Private mapprove_sendforprepress_date As String
        ...
        Public Property sendtographics_flag() As String
            Get
                Return msendtographics_flag
            End Get
            Set(ByVal value As String)
                msendtographics_flag = value
            End Set
        End Property

        Public Property sentographic_uid() As String
            Get
                Return msentographic_uid
            End Get
            Set(ByVal value As String)
                msentographic_uid = value
            End Set
        End Property

        Public Property sentographic_dt() As String
            Get
                Return msentographic_dt
            End Get
            Set(ByVal value As String)
                msentographic_dt = value
            End Set
        End Property
        ...
        Public Property approve_sendforprepress_uid() As String
            Get
                Return mapprove_sendforprepress_uid
            End Get
            Set(ByVal value As String)
                mapprove_sendforprepress_uid = value
            End Set
        End Property

        Public Property approve_sendforprepress_date() As String
            Get
                Return mapprove_sendforprepress_date
            End Get
            Set(ByVal value As String)
                mapprove_sendforprepress_date = value
            End Set
        End Property


        Public Property dispatch_close_flag() As String
            Get
                Return mdispatch_close_flag
            End Get
            Set(ByVal value As String)
                mdispatch_close_flag = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsJobEntry
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto", ""))
                ...
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobEntry = New clsJobEntry
                    ...
                    obj.assignedto = dt.Rows(0)("assignedto").ToString
                    ...
                    obj.cancelflag = dt.Rows(0)("cancelflag").ToString
                    obj.cancelremark = dt.Rows(0)("cancelremark").ToString
                    obj.dispatch_close_flag = dt.Rows(0)("dispatch_close_flag").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto", o.assignedto))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Update_Data_Add_Graphics(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@link5", o.link5))
            Com1.Parameters.Add(New SqlParameter("@customerinstruction", o.customerinstruction))
            Com1.Parameters.Add(New SqlParameter("@sendtographics_flag", o.sendtographics_flag))
            Com1.Parameters.Add(New SqlParameter("@sentographic_uid", o.sentographic_uid))
            Com1.Parameters.Add(New SqlParameter("@sentographic_dt", o.sentographic_dt))
        ...
        Public Shared Function Update_Data_Edit_Graphics(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Update_Data_Add_Prepress(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@link5", o.link5))
            Com1.Parameters.Add(New SqlParameter("@customerinstruction", o.customerinstruction))
            Com1.Parameters.Add(New SqlParameter("@approve_sendforprepress_flag", o.approve_sendforprepress_flag))
            Com1.Parameters.Add(New SqlParameter("@approve_sendforprepress_uid", o.approve_sendforprepress_uid))
            Com1.Parameters.Add(New SqlParameter("@approve_sendforprepress_date", o.approve_sendforprepress_date))
        ...
        Public Shared Function Update_Data_Edit_Prepress(ByVal o As clsJobEntry, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Delete(ByVal o As clsJobEntry) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
        ...
        Public Shared Function AmmendData(ByVal paramno As Integer, ByVal oldJobId As String, ByVal JobId As String) As Integer
            ...
            Ssql1 = "Sp_jobentryAmend_Close_AE"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function FillDataSrno(ByVal srno As String) As clsJobEntry
            Try
                Dim db As DBAccess = New DBAccess
                db.Parameters.Add(New SqlParameter("@srno", srno))

                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobentry_log_Detail_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsJobEntry = New clsJobEntry
                    If Not IsDBNull(dt.Rows(0)("jobid")) Then
                        obj.jobid = dt.Rows(0)("jobid").ToString
