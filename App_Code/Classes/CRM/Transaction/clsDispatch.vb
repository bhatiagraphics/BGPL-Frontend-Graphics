...
Namespace FOODERPWEB.Class
    Public Class clsDispatch
        ...
        Private massignedto_dispatch As String
        ...
        Private mdocketno As String
        Private mdispatch_comments As String
        ...
        Public Property dispatch_comments() As String
            Get
                Return mdispatch_comments
            End Get
            Set(ByVal value As String)
                mdispatch_comments = value
            End Set
        End Property
        ...
        Public Property assignedto_dispatch() As String
            Get
                Return massignedto_dispatch
            End Get
            Set(ByVal value As String)
                massignedto_dispatch = value
            End Set
        End Property
        ...
        Public Shared Function FillData(ByVal jobid As String, ByVal Flag As String) As clsDispatch
            Try
                ...
                db.Parameters.Add(New SqlParameter("@assignedto_dispatch", ""))
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_jobdispatch_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As clsDispatch = New clsDispatch
                    ...
                    obj.assignedto_dispatch = dt.Rows(0)("assignedto_dispatch").ToString
                    ...
                    obj.docketno = dt.Rows(0)("docketno").ToString
                    obj.dispatch_comments = dt.Rows(0)("dispatch_comments").ToString
        ...
        Public Shared Function Update_Data_Add(ByVal o As clsDispatch, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            ...
            Com1.Parameters.Add(New SqlParameter("@assignedto_appformgraphic", o.assignedto_dispatch))
        ...
        Public Shared Function Update_Data_Edit(ByVal o As clsDispatch, ByVal paramno As Integer, ByVal mode As String, ByVal ccode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
            ...
            Com1.Parameters.Add(New SqlParameter("@intcode", o.intcode))
            Com1.Parameters.Add(New SqlParameter("@revno", o.revno))
            Com1.Parameters.Add(New SqlParameter("@assignedto_dispatch", o.assignedto_dispatch))
            Com1.Parameters.Add(New SqlParameter("@ticketno", o.ticketno))
            Com1.Parameters.Add(New SqlParameter("@originaljobid", o.originaljobid))
            Com1.Parameters.Add(New SqlParameter("@jobversion", o.jobversion))
            Com1.Parameters.Add(New SqlParameter("@attachment1filename", o.attachment1filename))
            ...
            Com1.Parameters.Add(New SqlParameter("@docketno", o.docketno))
            Com1.Parameters.Add(New SqlParameter("@dispatch_comments", o.dispatch_comments))
        ...
        Public Shared Function Delete(ByVal o As clsDispatch) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
