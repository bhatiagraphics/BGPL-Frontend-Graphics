...
Namespace FOODERPWEB.Class
    Public Class ClsCustomerActivity
        ...
        Public Shared Function FillData(ByVal activityno As String, ByVal Flag As String) As ClsCustomerActivity
            Try
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_customeractivity_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As ClsCustomerActivity = New ClsCustomerActivity
                    If Not IsDBNull(dt.Rows(0)("activityno")) Then
                        obj.activityno = dt.Rows(0)("activityno").ToString
                    End If
                    If IsDBNull(dt.Rows(0)("cuscode").ToString) Then
                        obj.cuscode = ""
                    Else
        ...
        Public Shared Function Update_Data(ByVal o As ClsCustomerActivity, ByVal mode As String) As Integer
        ...
        Public Shared Function Find_ContactName(ByVal strcode As String) As String
            Dim s As Object
            Find_ContactName = ""
            s = DBAccess.Find_Value("crmcontacts", "cuscode", "contactname", Trim(strcode))
        ...
        Public Shared Function GetDocCode() As String
            ...
            sSQL = "SELECT MAX(cast(activityno as Integer)) AS activityno FROM customeractivity"
        ...
        Public Shared Function GetSrno(ByVal ContactCode As String) As String
            Dim sSQL As String, objDas As New DBAccess, dt As DataTable
            sSQL = "SELECT MAX(activitysrno) AS srno FROM customeractivity where cuscode ='" & Trim(ContactCode) & "'"
            dt = objDas.GetDataTable(sSQL)
            If dt.Rows.Count > 0 Then
