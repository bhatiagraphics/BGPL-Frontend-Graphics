...
Namespace FOODERPWEB.Class
    Public Class ClsProspectsDomesticPricelist
        ...
        Public Property paybasis() As String
            Get
                Return mpaybasis
            End Get
            Set(ByVal value As String)
        ...
        Public Shared Function FillDataRecall(ByVal contactcd As String, ByVal Flag As String) As ClsProspectsDomesticPricelist
            Try
                Dim db As DBAccess = New DBAccess
                db.Parameters.Add(New SqlParameter("@contactcd", contactcd))

                Dim dt As DataTable = db.ExecuteDataTable("Sp_prosdmpricelisthead_GetData_Recall")
                If dt.Rows.Count > 0 Then
                    Dim obj As ClsProspectsDomesticPricelist = New ClsProspectsDomesticPricelist
                    ...
                    obj.paybasis = dt.Rows(0)("paybasis").ToString
        ...
        Public Shared Function FillData(ByVal pricelistno As String, ByVal Flag As String) As ClsProspectsDomesticPricelist
            Try
                Dim db As DBAccess = New DBAccess
                ...
                Dim dt As DataTable = db.ExecuteDataTable("Sp_prosdmpricelisthead_GetData")
                If dt.Rows.Count > 0 Then
                    Dim obj As ClsProspectsDomesticPricelist = New ClsProspectsDomesticPricelist
        ...
        Public Shared Function DocumentCode() As String
            ...
            com.CommandText = "Select doccode from document where docname='Domestic Price List Prospect'"
            DocumentCode = ""
            Try
                con.Open()
        ...
        Public Shared Function GetDataForGride() As DataSet
            ...
            comdet.CommandText = "Select * from prosdmpricelistdet where pricelistno='" & Trim(docno) & "' order by pricelistno desc"
            dadet.SelectCommand = comdet

            Try
                dadet.Fill(ds, "prosdmpricelistdet")
            Catch ex As Exception
                Throw ex
            Finally
                con.Close()
            ...
            Return ds
        End Function
        Public Shared Function Update_Data_add(ByVal o As ClsProspectsDomesticPricelist, ByVal ds As DataSet, ByVal paramno As Integer, ByVal mode As String) As Integer
            Dim Con As SqlConnection
            ...
            comdet.Connection = Con
            comdet.CommandType = CommandType.Text
            Ssql2 = "Select * From prosdmpricelistdet Where pricelistno='" & Trim(docno) & "'"
            ...
            Ssql3 = "Delete From prosdmpricelistdet Where pricelistno='" & Trim(docno) & "'"
            ...
            Com1.Parameters.Add(New SqlParameter("@paybasis", o.paybasis))


            Com1.Parameters.Add(New SqlParameter("@type", o.type))
            ...
            Ssql1 = "Sp_prosdmpricelisthead_AE"
            ...
            Try
                ...
                i = dadet.Update(ds, "prosdmpricelistdet")
                Trans.Commit()
            Catch ex As Exception
        ...
        Public Shared Function Update_Data_Edit(ByVal o As ClsProspectsDomesticPricelist, ByVal ds As DataSet, ByVal mode As String) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim dadet As New SqlDataAdapter
            Dim comdetold As SqlCommand
        ...
        Public Shared Function Delete(ByVal o As ClsProspectsDomesticPricelist) As Integer
            Dim Con As SqlConnection
            Dim Trans As SqlTransaction
            Dim Com1 As SqlCommand
            Dim Ssql1 As String
            ...
            Ssql1 = "Sp_prosdmpricelisthead_Delete"
            Com1.CommandText = Ssql1
            Com1.Transaction = Trans
        ...
        Public Shared Function Check_Integrity(ByVal strcode As String) As String
            ...
            com.CommandText = "CheckIntegrity_prosdmpricelisthead_Sp"
