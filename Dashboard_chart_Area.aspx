<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Dashboard_chart_Area.aspx.vb" Inherits="Dashboard_chart_Area" %>
...
//         function LoadChart() {
             $(function () {
                 ...
                 $.ajax({
                     ...
                     url: 'Dashboard_chart_Area.aspx/GetChartData',
                     success:
                        function (response) {
