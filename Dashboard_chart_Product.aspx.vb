...
Partial Class Dashboard_chart_Product
    ...
    <WebMethod()>
    Public Shared Function GetChartData() As List(Of CLSTestingGraph2)
        Dim dt As New DataTable()
        Dim objDas As New DBAccess
        dt = objDas.GetDataTable("Productgroupwise_sales_graph_ytd_sp '" & Trim(uptodt) & "' ")
        'dt = objDas.GetDataTable("SP_GetOrderDataForPieChart 'user1','C1' ")
        Dim dataList As New List(Of CLSTestingGraph2)()
        For Each dtrow As DataRow In dt.Rows
            Dim details As New CLSTestingGraph2()
